...
namespace Zernio.Api
{
    ...
    public interface ILeadGenApiSync : IApiAccessor
    {
        ...
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="formId"></param>
        /// <param name="accountId">The facebook or metaads account whose Page owns the form.</param>
        /// <param name="leadId">The test lead id returned by createTestLead (or shown in the Testing Tool). Omitted &#x3D; the test lead currently on the form. (optional)</param>
        /// <returns>DeleteTestLead200Response</returns>
        DeleteTestLead200Response DeleteTestLead(string formId, string accountId, string? leadId = default);
        ...
        /// <param name="accountId">The facebook or metaads account whose Page owns the form.</param>
        /// <param name="leadId">The test lead id returned by createTestLead (or shown in the Testing Tool). Omitted &#x3D; the test lead currently on the form. (optional)</param>
        /// <returns>ApiResponse of DeleteTestLead200Response</returns>
        ApiResponse<DeleteTestLead200Response> DeleteTestLeadWithHttpInfo(string formId, string accountId, string? leadId = default);
        /// <summary>
        /// Get a lead form
        /// </summary>
        /// <remarks>
    ...
    public interface ILeadGenApiAsync : IApiAccessor
    {
        ...
        /// <param name="leadId">The test lead id returned by createTestLead (or shown in the Testing Tool). Omitted &#x3D; the test lead currently on the form. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeleteTestLead200Response</returns>
        System.Threading.Tasks.Task<DeleteTestLead200Response> DeleteTestLeadAsync(string formId, string accountId, string? leadId = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="leadId">The test lead id returned by createTestLead (or shown in the Testing Tool). Omitted &#x3D; the test lead currently on the form. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeleteTestLead200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeleteTestLead200Response>> DeleteTestLeadWithHttpInfoAsync(string formId, string accountId, string? leadId = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Get a lead form
        /// </summary>
        /// <remarks>
    ...
    public partial class LeadGenApi : IDisposable, ILeadGenApi
    {
        ...
        /// <summary>
        /// Delete a test lead Removes a test lead created for the form (DELETE /{leadgen_id}), so a new one can be submitted: Meta keeps one test lead per form and refuses a second until the first is gone. The same test lead appears in Meta&#39;s Lead Ads Testing Tool. Meta only deletes test leads; a real lead is refused. 
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="formId"></param>
        /// <param name="accountId">The facebook or metaads account whose Page owns the form.</param>
        /// <param name="leadId">The test lead id returned by createTestLead (or shown in the Testing Tool). Omitted &#x3D; the test lead currently on the form. (optional)</param>
        /// <returns>DeleteTestLead200Response</returns>
        public DeleteTestLead200Response DeleteTestLead(string formId, string accountId, string? leadId = default)
        {
            Zernio.Client.ApiResponse<DeleteTestLead200Response> localVarResponse = DeleteTestLeadWithHttpInfo(formId, accountId, leadId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="leadId">The test lead id returned by createTestLead (or shown in the Testing Tool). Omitted &#x3D; the test lead currently on the form. (optional)</param>
        /// <returns>ApiResponse of DeleteTestLead200Response</returns>
        public Zernio.Client.ApiResponse<DeleteTestLead200Response> DeleteTestLeadWithHttpInfo(string formId, string accountId, string? leadId = default)
        {
            // verify the required parameter 'formId' is set
            if (formId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'formId' when calling LeadGenApi->DeleteTestLead");

            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'accountId' when calling LeadGenApi->DeleteTestLead");
            ...
            if (leadId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Zernio.Client.ClientUtils.ParameterToMultiMap("", "leadId", leadId));
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<DeleteTestLead200Response>("/v1/ads/lead-forms/{formId}/test-leads", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteTestLead", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeleteTestLead200Response</returns>
        public async System.Threading.Tasks.Task<DeleteTestLead200Response> DeleteTestLeadAsync(string formId, string accountId, string? leadId = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<DeleteTestLead200Response> localVarResponse = await DeleteTestLeadWithHttpInfoAsync(formId, accountId, leadId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeleteTestLead200Response)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<DeleteTestLead200Response>> DeleteTestLeadWithHttpInfoAsync(string formId, string accountId, string? leadId = default, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'formId' is set
            if (formId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'formId' when calling LeadGenApi->DeleteTestLead");
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<DeleteTestLead200Response>("/v1/ads/lead-forms/{formId}/test-leads", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
