...
namespace Zernio.Api
{
    ...
    public partial class PostsApi : IDisposable, IPostsApi
    {
        ...
        {
            Zernio.Client.ApiResponse<PostCreateResponse> localVarResponse = CreatePostWithHttpInfo(createPostRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="createPostRequest"></param>
        /// <returns>ApiResponse of PostCreateResponse</returns>
        public Zernio.Client.ApiResponse<PostCreateResponse> CreatePostWithHttpInfo(CreatePostRequest createPostRequest)
        {
        ...
        {
            Zernio.Client.ApiResponse<PostCreateResponse> localVarResponse = await CreatePostWithHttpInfoAsync(createPostRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PostCreateResponse)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<PostCreateResponse>> CreatePostWithHttpInfoAsync(CreatePostRequest createPostRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'createPostRequest' is set
            if (createPostRequest == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'createPostRequest' when calling PostsApi->CreatePost");
