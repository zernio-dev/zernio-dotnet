...
namespace Zernio.Api
{
    ...
    public interface IUsageApiSync : IApiAccessor
    {
        ...
        /// <param name="profileId">Metering mode (pair with &#x60;range&#x60;). Project the payload onto this profile&#39;s attributed share. Mutually exclusive with &#x60;accountId&#x60;, and &#x60;groupBy&#x60; (if given) must be &#x60;profile&#x60;; 404 when the profile is not in your workspace (or outside a scoped key&#39;s profiles). (optional)</param>
