...
namespace Zernio.Api
{
    ...
    public interface IUsageApiSync : IApiAccessor
    {
        ...
        /// <returns>BillingSnapshot</returns>
        ...
        /// </remarks>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of BillingSnapshot</returns>
        ApiResponse<BillingSnapshot> GetBillingWithHttpInfo();
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="reconcile">Snapshot mode only. For Stripe subscription users, &#x60;true&#x60; forces a subscription reconciliation pass even when cached plan data looks complete.  (optional)</param>
        /// <param name="range">Window to report. &#x60;cycle&#x60; / &#x60;prev-cycle&#x60; resolve to the customer&#39;s real billing-period bounds (falling back to a trailing 30 days when no invoice exists yet); &#x60;7d&#x60;…&#x60;12mo&#x60; are trailing windows; &#x60;custom&#x60; uses &#x60;from&#x60; / &#x60;to&#x60;.  (optional, default to cycle)</param>
        /// <param name="from">Inclusive start (UTC date). Required when &#x60;range&#x3D;custom&#x60;. (optional)</param>
        /// <param name="to">Inclusive end (UTC date). Required when &#x60;range&#x3D;custom&#x60;. Max span 366 days. (optional)</param>
        /// <param name="granularity">Bucketing of the &#x60;days&#x60; series: &#x60;day&#x60; (one row per UTC day), &#x60;month&#x60; (one row per calendar month, dated to the 1st), or &#x60;total&#x60; (no series, read &#x60;totals&#x60;). Does not affect &#x60;totals&#x60;.  (optional, default to day)</param>
        /// <param name="groupBy">Metering mode. Adds &#x60;attribution&#x60;: the window&#39;s spend split per profile or per account (keys are ids; resolve names via &#x60;GET /v1/profiles&#x60; / &#x60;GET /v1/accounts&#x60;). (optional)</param>
        /// <param name="profileId">Metering mode (pair with &#x60;range&#x60;). Project the payload onto this profile&#39;s attributed share. Mutually exclusive with &#x60;accountId&#x60;, and &#x60;groupBy&#x60; (if given) must be &#x60;profile&#x60;; 404 when the profile is not in your team (or outside a scoped key&#39;s profiles). (optional)</param>
        /// <param name="accountId">Metering mode (pair with &#x60;range&#x60;). Project the payload onto this account&#39;s attributed share. Mutually exclusive with &#x60;profileId&#x60;, and &#x60;groupBy&#x60; (if given) must be &#x60;account&#x60;; 404 when the account is not visible to the caller. (optional)</param>
        /// <returns>GetUsage200Response</returns>
        GetUsage200Response GetUsage(bool? reconcile = default, string? range = default, DateOnly? from = default, DateOnly? to = default, string? granularity = default, string? groupBy = default, string? profileId = default, string? accountId = default);
        ...
        ApiResponse<GetUsage200Response> GetUsageWithHttpInfo(bool? reconcile = default, string? range = default, DateOnly? from = default, DateOnly? to = default, string? granularity = default, string? groupBy = default, string? profileId = default, string? accountId = default);
        /// <summary>
    ...
    public interface IUsageApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of BillingSnapshot</returns>
        System.Threading.Tasks.Task<BillingSnapshot> GetBillingAsync(System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BillingSnapshot)</returns>
        System.Threading.Tasks.Task<ApiResponse<BillingSnapshot>> GetBillingWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Calling usage and cost
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GetUsage200Response> GetUsageAsync(bool? reconcile = default, string? range = default, DateOnly? from = default, DateOnly? to = default, string? granularity = default, string? groupBy = default, string? profileId = default, string? accountId = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetUsage200Response>> GetUsageWithHttpInfoAsync(bool? reconcile = default, string? range = default, DateOnly? from = default, DateOnly? to = default, string? granularity = default, string? groupBy = default, string? profileId = default, string? accountId = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Get plan and usage snapshot (plan, limits, payment status)
        /// </summary>
        /// <remarks>
    ...
    public partial class UsageApi : IDisposable, IUsageApi
    {
        ...
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>BillingSnapshot</returns>
        public BillingSnapshot GetBilling()
        {
            Zernio.Client.ApiResponse<BillingSnapshot> localVarResponse = GetBillingWithHttpInfo();
        ...
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of BillingSnapshot</returns>
        public Zernio.Client.ApiResponse<BillingSnapshot> GetBillingWithHttpInfo()
        {
            ...
            var localVarResponse = this.Client.Get<BillingSnapshot>("/v1/billing", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBilling", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BillingSnapshot</returns>
        public async System.Threading.Tasks.Task<BillingSnapshot> GetBillingAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<BillingSnapshot> localVarResponse = await GetBillingWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BillingSnapshot)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<BillingSnapshot>> GetBillingWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<BillingSnapshot>("/v1/billing", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Usage snapshot (default) or billed-spend metering (with params) Dual-mode endpoint, selected by query params, and fully backward compatible:  **Without metering params (the default):** the plan / quota / usage snapshot: plan name, billing period, limits, usage counts, access state. Identical to &#x60;GET /v1/usage-stats&#x60;. Existing integrations keep working unchanged.  **With &#x60;range&#x60;, &#x60;granularity&#x60;, &#x60;from&#x60;, or &#x60;to&#x60;:** usage METERING: billed spend (USD) by product family (&#x60;accounts&#x60;, &#x60;numbers&#x60;, &#x60;imessage&#x60;, &#x60;calls&#x60;, &#x60;sms&#x60;, &#x60;messages&#x60;, &#x60;verify&#x60;, &#x60;dlc&#x60;, &#x60;xApi&#x60;, &#x60;ads&#x60;, &#x60;credits&#x60;, &#x60;other&#x60;) over the window, at &#x60;day&#x60; / &#x60;month&#x60; / &#x60;total&#x60; granularity, from the usage-based invoice breakdown (the CHARGE view, which always reconciles with what gets billed). Also served at &#x60;GET /v1/usage/daily&#x60;. Usage-based accounts only: legacy Stripe accounts get &#x60;{ \&quot;supported\&quot;: false, \&quot;days\&quot;: [] }&#x60;.  **Attribution (metering mode):** &#x60;groupBy&#x3D;profile|account&#x60; adds an &#x60;attribution&#x60; breakdown of the window&#39;s spend per profile or account, assembled from your own records and pro-rated against the invoice so &#x60;sum(groups) + unattributed&#x60; equals &#x60;totals&#x60; exactly. &#x60;profileId&#x60; / &#x60;accountId&#x60; instead project the whole payload (&#x60;days&#x60;, &#x60;totals&#x60;, &#x60;lineItems&#x60;) onto that one group; &#x60;peaks&#x60;, &#x60;callUsage&#x60; and &#x60;tax&#x60; are then &#x60;null&#x60; (team-level facts). Projected &#x60;days&#x60; spread the group&#39;s period share over each day (usage is attributed per period, not per day). Profile-scoped API keys and members only see their profiles&#39; groups (&#x60;attribution.restricted: true&#x60;, with &#x60;totals&#x60; summing the visible groups). Credits, 10DLC fees and Verify are always unattributed. &#x60;profileId&#x60; / &#x60;accountId&#x60; on their own do not select metering mode: pair them with &#x60;range&#x60;.  For per-domain consumption *volumes* use &#x60;GET /v1/usage/calls&#x60; and &#x60;GET /v1/usage/sms&#x60;. For the billing statement (balance, credits, caps, payment status) use &#x60;GET /v1/billing&#x60;. 
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="reconcile">Snapshot mode only. For Stripe subscription users, &#x60;true&#x60; forces a subscription reconciliation pass even when cached plan data looks complete.  (optional)</param>
        /// <param name="range">Window to report. &#x60;cycle&#x60; / &#x60;prev-cycle&#x60; resolve to the customer&#39;s real billing-period bounds (falling back to a trailing 30 days when no invoice exists yet); &#x60;7d&#x60;…&#x60;12mo&#x60; are trailing windows; &#x60;custom&#x60; uses &#x60;from&#x60; / &#x60;to&#x60;.  (optional, default to cycle)</param>
        ...
        /// <param name="accountId">Metering mode (pair with &#x60;range&#x60;). Project the payload onto this account&#39;s attributed share. Mutually exclusive with &#x60;profileId&#x60;, and &#x60;groupBy&#x60; (if given) must be &#x60;account&#x60;; 404 when the account is not visible to the caller. (optional)</param>
        /// <returns>GetUsage200Response</returns>
        public GetUsage200Response GetUsage(bool? reconcile = default, string? range = default, DateOnly? from = default, DateOnly? to = default, string? granularity = default, string? groupBy = default, string? profileId = default, string? accountId = default)
        {
            Zernio.Client.ApiResponse<GetUsage200Response> localVarResponse = GetUsageWithHttpInfo(reconcile, range, from, to, granularity, groupBy, profileId, accountId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="accountId">Metering mode (pair with &#x60;range&#x60;). Project the payload onto this account&#39;s attributed share. Mutually exclusive with &#x60;profileId&#x60;, and &#x60;groupBy&#x60; (if given) must be &#x60;account&#x60;; 404 when the account is not visible to the caller. (optional)</param>
        /// <returns>ApiResponse of GetUsage200Response</returns>
        public Zernio.Client.ApiResponse<GetUsage200Response> GetUsageWithHttpInfo(bool? reconcile = default, string? range = default, DateOnly? from = default, DateOnly? to = default, string? granularity = default, string? groupBy = default, string? profileId = default, string? accountId = default)
        {
            Zernio.Client.RequestOptions localVarRequestOptions = new Zernio.Client.RequestOptions();
            ...
            if (range != null)
            {
                localVarRequestOptions.QueryParameters.Add(Zernio.Client.ClientUtils.ParameterToMultiMap("", "range", range));
            }
            if (from != null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GetUsage200Response>("/v1/usage", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetUsage200Response</returns>
        public async System.Threading.Tasks.Task<GetUsage200Response> GetUsageAsync(bool? reconcile = default, string? range = default, DateOnly? from = default, DateOnly? to = default, string? granularity = default, string? groupBy = default, string? profileId = default, string? accountId = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<GetUsage200Response> localVarResponse = await GetUsageWithHttpInfoAsync(reconcile, range, from, to, granularity, groupBy, profileId, accountId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetUsage200Response)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<GetUsage200Response>> GetUsageWithHttpInfoAsync(bool? reconcile = default, string? range = default, DateOnly? from = default, DateOnly? to = default, string? granularity = default, string? groupBy = default, string? profileId = default, string? accountId = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetUsage200Response>("/v1/usage", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Get X API pricing table Returns Zernio&#39;s canonical X API pricing table. Each X action has its own billing product and its own rate, and Zernio passes X API costs through at exact rates with zero markup.  The response is identical for every authenticated user (pricing is universal), so it is safe to cache on the client for the duration of a billing period.  To compute your own per-operation spend, pair this endpoint with &#x60;GET /v1/usage-stats&#x60;, which returns &#x60;usage.xApiCallsByOperation&#x60; keyed by the same &#x60;operation&#x60; field you get here. 
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>XApiPricing</returns>
