...
namespace Zernio.Api
{
    ...
    public interface IConnectApiSync : IApiAccessor
    {
        ...
        ConnectAds200Response ConnectAds(string platform, string profileId, string? loginMode = default, string? pageId = default, string? accountId = default, string? redirectUrl = default, bool? headless = default, bool? force = default, string? adAccountId = default, List<string>? adAccountIds = default);
        ...
        ApiResponse<ConnectAds200Response> ConnectAdsWithHttpInfo(string platform, string profileId, string? loginMode = default, string? pageId = default, string? accountId = default, string? redirectUrl = default, bool? headless = default, bool? force = default, string? adAccountId = default, List<string>? adAccountIds = default);
        /// <summary>
    ...
    public partial class ConnectApi : IDisposable, IConnectApi
    {
        ...
        /// <param name="adAccountIds">Scope ad sync to multiple platform ad accounts (same platform support and id shapes as &#x60;adAccountId&#x60;). Repeat the param (&#x60;?adAccountIds&#x3D;act_1&amp;adAccountIds&#x3D;act_2&#x60;) or comma-separate (&#x60;?adAccountIds&#x3D;act_1,act_2&#x60;). Persisted server-side; latest call wins, and de-scoped ad accounts have their synced ads removed. Omitting both &#x60;adAccountId&#x60; and &#x60;adAccountIds&#x60; keeps any previously persisted scope unchanged.  (optional)</param>
        /// <returns>ConnectAds200Response</returns>
        public ConnectAds200Response ConnectAds(string platform, string profileId, string? loginMode = default, string? pageId = default, string? accountId = default, string? redirectUrl = default, bool? headless = default, bool? force = default, string? adAccountId = default, List<string>? adAccountIds = default)
        {
            Zernio.Client.ApiResponse<ConnectAds200Response> localVarResponse = ConnectAdsWithHttpInfo(platform, profileId, loginMode, pageId, accountId, redirectUrl, headless, force, adAccountId, adAccountIds);
            return localVarResponse.Data;
        }
        ...
        {
            Zernio.Client.ApiResponse<ConnectAds200Response> localVarResponse = await ConnectAdsWithHttpInfoAsync(platform, profileId, loginMode, pageId, accountId, redirectUrl, headless, force, adAccountId, adAccountIds, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
