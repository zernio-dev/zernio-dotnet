...
namespace Zernio.Api
{
    ...
    public interface IAdInsightsApiSync : IApiAccessor
    {
        ...
        /// <param name="adSetId">Platform ad set ID (Google ad group). Same value as adSetId on listAdKeywords and /ad-sets/{adSetId}/assets. (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accountId">A tiktok or tiktokads account ID</param>
        /// <param name="adAccountId">TikTok advertiser ID</param>
        /// <param name="startDate">YYYY-MM-DD, in the advertiser&#39;s time zone</param>
        /// <param name="endDate">YYYY-MM-DD, on or after startDate</param>
        /// <param name="level">Key each row by Smart+ ad or by ad group (optional, default to ad)</param>
        /// <param name="smartPlusAdIds">Comma-separated Smart+ ad ids to filter by (up to 100) (optional)</param>
        /// <param name="adGroupIds">Comma-separated ad group ids to filter by (up to 100) (optional)</param>
        /// <param name="page"> (optional, default to 1)</param>
        /// <param name="pageSize"> (optional, default to 100)</param>
        /// <returns>GetTikTokSmartPlusMaterialReport200Response</returns>
        GetTikTokSmartPlusMaterialReport200Response GetTikTokSmartPlusMaterialReport(string accountId, string adAccountId, DateOnly startDate, DateOnly endDate, string? level = default, string? smartPlusAdIds = default, string? adGroupIds = default, int? page = default, int? pageSize = default);
        ...
        /// <param name="page"> (optional, default to 1)</param>
        /// <param name="pageSize"> (optional, default to 100)</param>
        /// <returns>ApiResponse of GetTikTokSmartPlusMaterialReport200Response</returns>
        ApiResponse<GetTikTokSmartPlusMaterialReport200Response> GetTikTokSmartPlusMaterialReportWithHttpInfo(string accountId, string adAccountId, DateOnly startDate, DateOnly endDate, string? level = default, string? smartPlusAdIds = default, string? adGroupIds = default, int? page = default, int? pageSize = default);
        /// <summary>
        ...
        /// <param name="actionBreakdowns">Comma-separated Graph action breakdowns; segments the actions[] arrays in each row. Pass &#x60;none&#x60; to clear Meta&#39;s default action_type breakdown, required to combine some non-action breakdowns such as instagram_ads_follow_type (otherwise Meta returns a (#100) invalid-combination error). (optional)</param>
    ...
    public interface IAdInsightsApiAsync : IApiAccessor
    {
        ...
        /// <param name="pageSize"> (optional, default to 100)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetTikTokSmartPlusMaterialReport200Response</returns>
        System.Threading.Tasks.Task<GetTikTokSmartPlusMaterialReport200Response> GetTikTokSmartPlusMaterialReportAsync(string accountId, string adAccountId, DateOnly startDate, DateOnly endDate, string? level = default, string? smartPlusAdIds = default, string? adGroupIds = default, int? page = default, int? pageSize = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="pageSize"> (optional, default to 100)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetTikTokSmartPlusMaterialReport200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<GetTikTokSmartPlusMaterialReport200Response>> GetTikTokSmartPlusMaterialReportWithHttpInfoAsync(string accountId, string adAccountId, DateOnly startDate, DateOnly endDate, string? level = default, string? smartPlusAdIds = default, string? adGroupIds = default, int? page = default, int? pageSize = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// List lead conversations
        /// </summary>
        /// <remarks>
    ...
    public partial class AdInsightsApi : IDisposable, IAdInsightsApi
    {
        ...
        /// <summary>
        /// Per-creative performance inside TikTok Smart+ ads Breaks a Smart+ ad (or ad group) down by creative material, one row per Spark post, video or image, from TikTok&#39;s Smart+ material report. For a Spark post &#x60;tiktokItemId&#x60; is the TikTok post id. Conversion metrics are TikTok web (pixel) events. TikTok allows two dimensions per report, so rows are keyed by the Smart+ ad (&#x60;level&#x3D;ad&#x60;) or by the ad group (&#x60;level&#x3D;adGroup&#x60;), not both. Metrics TikTok returns empty come back as null.
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accountId">A tiktok or tiktokads account ID</param>
        /// <param name="adAccountId">TikTok advertiser ID</param>
        ...
        /// <param name="pageSize"> (optional, default to 100)</param>
        /// <returns>GetTikTokSmartPlusMaterialReport200Response</returns>
        public GetTikTokSmartPlusMaterialReport200Response GetTikTokSmartPlusMaterialReport(string accountId, string adAccountId, DateOnly startDate, DateOnly endDate, string? level = default, string? smartPlusAdIds = default, string? adGroupIds = default, int? page = default, int? pageSize = default)
        {
            Zernio.Client.ApiResponse<GetTikTokSmartPlusMaterialReport200Response> localVarResponse = GetTikTokSmartPlusMaterialReportWithHttpInfo(accountId, adAccountId, startDate, endDate, level, smartPlusAdIds, adGroupIds, page, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="pageSize"> (optional, default to 100)</param>
        /// <returns>ApiResponse of GetTikTokSmartPlusMaterialReport200Response</returns>
        public Zernio.Client.ApiResponse<GetTikTokSmartPlusMaterialReport200Response> GetTikTokSmartPlusMaterialReportWithHttpInfo(string accountId, string adAccountId, DateOnly startDate, DateOnly endDate, string? level = default, string? smartPlusAdIds = default, string? adGroupIds = default, int? page = default, int? pageSize = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'accountId' when calling AdInsightsApi->GetTikTokSmartPlusMaterialReport");

            // verify the required parameter 'adAccountId' is set
            if (adAccountId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'adAccountId' when calling AdInsightsApi->GetTikTokSmartPlusMaterialReport");
            ...
            if (smartPlusAdIds != null)
            {
                localVarRequestOptions.QueryParameters.Add(Zernio.Client.ClientUtils.ParameterToMultiMap("", "smartPlusAdIds", smartPlusAdIds));
            }
            if (adGroupIds != null)
            {
                localVarRequestOptions.QueryParameters.Add(Zernio.Client.ClientUtils.ParameterToMultiMap("", "adGroupIds", adGroupIds));
            }
            if (page != null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GetTikTokSmartPlusMaterialReport200Response>("/v1/ads/tiktok-smart-plus-materials", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetTikTokSmartPlusMaterialReport", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetTikTokSmartPlusMaterialReport200Response</returns>
        public async System.Threading.Tasks.Task<GetTikTokSmartPlusMaterialReport200Response> GetTikTokSmartPlusMaterialReportAsync(string accountId, string adAccountId, DateOnly startDate, DateOnly endDate, string? level = default, string? smartPlusAdIds = default, string? adGroupIds = default, int? page = default, int? pageSize = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<GetTikTokSmartPlusMaterialReport200Response> localVarResponse = await GetTikTokSmartPlusMaterialReportWithHttpInfoAsync(accountId, adAccountId, startDate, endDate, level, smartPlusAdIds, adGroupIds, page, pageSize, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetTikTokSmartPlusMaterialReport200Response)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<GetTikTokSmartPlusMaterialReport200Response>> GetTikTokSmartPlusMaterialReportWithHttpInfoAsync(string accountId, string adAccountId, DateOnly startDate, DateOnly endDate, string? level = default, string? smartPlusAdIds = default, string? adGroupIds = default, int? page = default, int? pageSize = default, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'accountId' when calling AdInsightsApi->GetTikTokSmartPlusMaterialReport");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetTikTokSmartPlusMaterialReport200Response>("/v1/ads/tiktok-smart-plus-materials", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
