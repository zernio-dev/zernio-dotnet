...
namespace Zernio.Api
{
    ...
    public partial class APIKeysApi : IDisposable, IAPIKeysApi
    {
        ...
        /// <summary>
        /// Delete key Permanently revokes and deletes an API key. The team owner can revoke any team member&#39;s key; a non-owner member can only revoke their own.
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="keyId"></param>
        /// <returns>DeleteAccountGroup200Response</returns>
        ...
        /// <summary>
        /// List keys Returns API keys with a preview only, not the full key value. For a regular team member this is their own keys; for the team owner this is every team member&#39;s keys, each carrying a &#x60;createdBy&#x60; field.
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ListApiKeys200Response</returns>
