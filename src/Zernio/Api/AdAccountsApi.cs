...
namespace Zernio.Api
{
    ...
    public interface IAdAccountsApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accountId">Zernio Meta Ads, Facebook or Instagram SocialAccount ID.</param>
        /// <param name="adAccountId">Meta ad account ID including the act_ prefix. Narrows identity resolution to the Instagram accounts reachable from this ad account. (optional)</param>
        /// <param name="igUserId">Instagram identity to list. Must be one this connection can reach, otherwise the request is rejected with a 400. (optional)</param>
        /// <param name="limit">Number of posts to return per page. (optional, default to 25)</param>
        /// <param name="after">Opaque Meta cursor from a previous response&#39;s paging.after. (optional)</param>
        /// <returns>ListAdsInstagramPosts200Response</returns>
        ListAdsInstagramPosts200Response ListAdsInstagramPosts(string accountId, string? adAccountId = default, string? igUserId = default, int? limit = default, string? after = default);
        ...
        /// <param name="limit">Number of posts to return per page. (optional, default to 25)</param>
        /// <param name="after">Opaque Meta cursor from a previous response&#39;s paging.after. (optional)</param>
        /// <returns>ApiResponse of ListAdsInstagramPosts200Response</returns>
        ApiResponse<ListAdsInstagramPosts200Response> ListAdsInstagramPostsWithHttpInfo(string accountId, string? adAccountId = default, string? igUserId = default, int? limit = default, string? after = default);
        /// <summary>
    ...
    public interface IAdAccountsApiAsync : IApiAccessor
    {
        ...
        /// <param name="after">Opaque Meta cursor from a previous response&#39;s paging.after. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ListAdsInstagramPosts200Response</returns>
        System.Threading.Tasks.Task<ListAdsInstagramPosts200Response> ListAdsInstagramPostsAsync(string accountId, string? adAccountId = default, string? igUserId = default, int? limit = default, string? after = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="after">Opaque Meta cursor from a previous response&#39;s paging.after. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListAdsInstagramPosts200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<ListAdsInstagramPosts200Response>> ListAdsInstagramPostsWithHttpInfoAsync(string accountId, string? adAccountId = default, string? igUserId = default, int? limit = default, string? after = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// List advertisable apps
        /// </summary>
        /// <remarks>
    ...
    public partial class AdAccountsApi : IDisposable, IAdAccountsApi
    {
        ...
        /// <param name="after">Opaque Meta cursor from a previous response&#39;s paging.after. (optional)</param>
        /// <returns>ListAdsInstagramPosts200Response</returns>
        public ListAdsInstagramPosts200Response ListAdsInstagramPosts(string accountId, string? adAccountId = default, string? igUserId = default, int? limit = default, string? after = default)
        {
            Zernio.Client.ApiResponse<ListAdsInstagramPosts200Response> localVarResponse = ListAdsInstagramPostsWithHttpInfo(accountId, adAccountId, igUserId, limit, after);
            return localVarResponse.Data;
        }
        ...
        /// <param name="after">Opaque Meta cursor from a previous response&#39;s paging.after. (optional)</param>
        /// <returns>ApiResponse of ListAdsInstagramPosts200Response</returns>
        public Zernio.Client.ApiResponse<ListAdsInstagramPosts200Response> ListAdsInstagramPostsWithHttpInfo(string accountId, string? adAccountId = default, string? igUserId = default, int? limit = default, string? after = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'accountId' when calling AdAccountsApi->ListAdsInstagramPosts");
            ...
            if (igUserId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Zernio.Client.ClientUtils.ParameterToMultiMap("", "igUserId", igUserId));
            }
            if (limit != null)
            {
                localVarRequestOptions.QueryParameters.Add(Zernio.Client.ClientUtils.ParameterToMultiMap("", "limit", limit));
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ListAdsInstagramPosts200Response>("/v1/ads/instagram-posts", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ListAdsInstagramPosts", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ListAdsInstagramPosts200Response</returns>
        public async System.Threading.Tasks.Task<ListAdsInstagramPosts200Response> ListAdsInstagramPostsAsync(string accountId, string? adAccountId = default, string? igUserId = default, int? limit = default, string? after = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<ListAdsInstagramPosts200Response> localVarResponse = await ListAdsInstagramPostsWithHttpInfoAsync(accountId, adAccountId, igUserId, limit, after, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListAdsInstagramPosts200Response)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<ListAdsInstagramPosts200Response>> ListAdsInstagramPostsWithHttpInfoAsync(string accountId, string? adAccountId = default, string? igUserId = default, int? limit = default, string? after = default, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'accountId' when calling AdAccountsApi->ListAdsInstagramPosts");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ListAdsInstagramPosts200Response>("/v1/ads/instagram-posts", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Zernio.Client.ApiResponse<ListTikTokAdPixels200Response> ListTikTokAdPixelsWithHttpInfo(string accountId, string? adAccountId = default, string? advertiserId = default, string? code = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'accountId' when calling AdAccountsApi->ListTikTokAdPixels");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ListTikTokAdPixels200Response>("/v1/ads/pixels", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ListTikTokAdPixels", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<ListTikTokAdPixels200Response>> ListTikTokAdPixelsWithHttpInfoAsync(string accountId, string? adAccountId = default, string? advertiserId = default, string? code = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ListTikTokAdPixels200Response>("/v1/ads/pixels", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
