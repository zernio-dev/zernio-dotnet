...
namespace Zernio.Api
{
    ...
    public interface IAnalyticsApiSync : IApiAccessor
    {
        ...
        /// <param name="sortBy">Sort by date, engagement, or a specific metric. Platform-specific metrics (follows, reposts, reels_skip_rate, ig_reels_*, completion_rate, profile_views, website_clicks) sort a null value as 0. (optional, default to date)</param>
        ...
        /// </remarks>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cursor">Opaque cursor from a previous response&#39;s &#x60;nextCursor&#x60;. Omit it to start from now: the response is then an empty page carrying the feed&#39;s current position. Rejected with a &#x60;400&#x60; when malformed, or when older than the retention window.  (optional)</param>
        /// <param name="limit">Page size. Out-of-range values are a 400, never a silent clamp. (optional, default to 50)</param>
        /// <param name="platform">Filter to a single platform (for example \&quot;youtube\&quot;). Omit for every platform. (optional)</param>
        /// <param name="profileId">Filter by profile ID (default \&quot;all\&quot;). Must be a valid profile ID or \&quot;all\&quot;. (optional, default to &quot;all&quot;)</param>
        /// <returns>AnalyticsDeltaResponse</returns>
        AnalyticsDeltaResponse GetAnalyticsDelta(string? cursor = default, int? limit = default, string? platform = default, string? profileId = default);
        ...
        /// <param name="platform">Filter to a single platform (for example \&quot;youtube\&quot;). Omit for every platform. (optional)</param>
        /// <param name="profileId">Filter by profile ID (default \&quot;all\&quot;). Must be a valid profile ID or \&quot;all\&quot;. (optional, default to &quot;all&quot;)</param>
        /// <returns>ApiResponse of AnalyticsDeltaResponse</returns>
        ApiResponse<AnalyticsDeltaResponse> GetAnalyticsDeltaWithHttpInfo(string? cursor = default, int? limit = default, string? platform = default, string? profileId = default);
        /// <summary>
        ...
        /// <param name="accountId">Filter by account ID. Omit for all accounts. (optional)</param>
        ...
        InstagramAccountInsightsResponse GetFacebookPageInsights(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default);
        ...
        ApiResponse<InstagramAccountInsightsResponse> GetFacebookPageInsightsWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default);
        /// <summary>
        ...
        /// <param name="postId">The platform post ID, exactly as returned in platformAnalytics[].platformPostId by /v1/analytics: \&quot;{pageId}_{postId}\&quot;, or the bare video ID for Reels. </param>
        /// <param name="metrics">Comma-separated list of monetization metrics. Defaults to both:   - content_monetization_earnings   - monetization_approximate_earnings  content_monetization_earnings always carries unit \&quot;micro_amount\&quot; plus an ISO 4217 \&quot;currency\&quot;. monetization_approximate_earnings is always a bare number, so its unit is \&quot;unspecified\&quot; and its \&quot;currency\&quot; is null. The two are on different scales and are not comparable to each other. Any other metric name is rejected with 400.  (optional)</param>
        /// <returns>ApiResponse of FacebookPostEarningsResponse</returns>
        ApiResponse<FacebookPostEarningsResponse> GetFacebookPostEarningsWithHttpInfo(string accountId, string postId, string? metrics = default);
        /// <summary>
        ...
        /// <param name="fromDate">Start date (YYYY-MM-DD). Defaults to 30 days ago. Max 18 months back. (optional)</param>
        /// <param name="toDate">End date (YYYY-MM-DD). Defaults to today. (optional)</param>
        /// <param name="startDate">Alias of fromDate, kept for existing callers (optional) (deprecated)</param>
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        /// <returns>GetGoogleBusinessPerformance200Response</returns>
        GetGoogleBusinessPerformance200Response GetGoogleBusinessPerformance(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default);
        ...
        ApiResponse<GetGoogleBusinessPerformance200Response> GetGoogleBusinessPerformanceWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default);
        /// <summary>
        ...
        /// <returns>InstagramAccountInsightsResponse</returns>
        InstagramAccountInsightsResponse GetInstagramAccountInsights(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, string? breakdown = default);
        ...
        /// <param name="breakdown">Breakdown dimension (only valid with metricType&#x3D;total_value). Valid values depend on the metric: media_product_type, follow_type, follower_type, contact_button_type.  (optional)</param>
        /// <returns>ApiResponse of InstagramAccountInsightsResponse</returns>
        ApiResponse<InstagramAccountInsightsResponse> GetInstagramAccountInsightsWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, string? breakdown = default);
        /// <summary>
        ...
        /// <returns>InstagramAccountInsightsResponse</returns>
        InstagramAccountInsightsResponse GetInstagramFollowerHistory(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default);
        ...
        /// <param name="metricType">\&quot;total_value\&quot; returns aggregated totals (latest for follower_count, sum for gained/lost). \&quot;time_series\&quot; returns per-day values in the \&quot;values\&quot; array.  (optional, default to total_value)</param>
        /// <returns>ApiResponse of InstagramAccountInsightsResponse</returns>
        ApiResponse<InstagramAccountInsightsResponse> GetInstagramFollowerHistoryWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default);
        /// <summary>
        ...
        /// <param name="fromDate">Start date (YYYY-MM-DD). If omitted, returns lifetime analytics. (optional)</param>
        /// <param name="toDate">End date (YYYY-MM-DD, exclusive). Defaults to today if omitted. (optional)</param>
        /// <param name="startDate">Alias of fromDate, kept for existing callers (optional) (deprecated)</param>
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        ...
        GetLinkedInAggregateAnalytics200Response GetLinkedInAggregateAnalytics(string accountId, string? aggregation = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, string? metrics = default);
        ...
        ApiResponse<GetLinkedInAggregateAnalytics200Response> GetLinkedInAggregateAnalyticsWithHttpInfo(string accountId, string? aggregation = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, string? metrics = default);
        /// <summary>
        ...
        /// <returns>InstagramAccountInsightsResponse</returns>
        InstagramAccountInsightsResponse GetLinkedInOrgAggregateAnalytics(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default);
        ...
        /// <param name="metricType"> (optional, default to total_value)</param>
        /// <returns>ApiResponse of InstagramAccountInsightsResponse</returns>
        ApiResponse<InstagramAccountInsightsResponse> GetLinkedInOrgAggregateAnalyticsWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default);
        /// <summary>
        ...
        /// <returns>InstagramAccountInsightsResponse</returns>
        InstagramAccountInsightsResponse GetTikTokAccountInsights(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default);
        ...
        /// <param name="metricType">\&quot;total_value\&quot; returns the latest cumulative counter value. \&quot;time_series\&quot; returns daily values joined from AccountStats snapshots.  (optional, default to total_value)</param>
        /// <returns>ApiResponse of InstagramAccountInsightsResponse</returns>
        ApiResponse<InstagramAccountInsightsResponse> GetTikTokAccountInsightsWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default);
        /// <summary>
        ...
        /// <param name="fromDate">Start date (YYYY-MM-DD). Defaults to 30 days ago. (optional)</param>
        /// <param name="toDate">End date (YYYY-MM-DD). Defaults to today. YouTube Analytics has a 2-3 day delay, so the fetch is internally clamped to 3 days ago; any requested range extending beyond that returns zero values for the tail days. The response&#39;s dateRange.until field reflects your requested value.  (optional)</param>
        /// <param name="since">Alias of fromDate, kept for existing callers (optional) (deprecated)</param>
        /// <param name="until">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        ...
        /// <returns>InstagramAccountInsightsResponse</returns>
        InstagramAccountInsightsResponse GetYouTubeChannelInsights(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default);
        ...
        /// <param name="metricType">\&quot;total_value\&quot; (default) returns aggregated totals. \&quot;time_series\&quot; returns per-day values in the \&quot;values\&quot; array.  (optional, default to total_value)</param>
        /// <returns>ApiResponse of InstagramAccountInsightsResponse</returns>
        ApiResponse<InstagramAccountInsightsResponse> GetYouTubeChannelInsightsWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default);
        /// <summary>
        ...
        /// <param name="fromDate">Start date (YYYY-MM-DD). Defaults to 30 days ago. (optional)</param>
        /// <param name="toDate">End date (YYYY-MM-DD). Defaults to 3 days ago, the newest fully finalized day (YouTube finalizes analytics with a ~3-day delay). An explicit toDate is honored up to today: days inside the delay window are provisional and may still be revised by YouTube (see provisionalSince in the response), and days YouTube has not processed yet are omitted from dailyViews.  (optional)</param>
        /// <param name="startDate">Alias of fromDate, kept for existing callers (optional) (deprecated)</param>
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        /// <returns>YouTubeDailyViewsResponse</returns>
        YouTubeDailyViewsResponse GetYouTubeDailyViews(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default);
        ...
        ApiResponse<YouTubeDailyViewsResponse> GetYouTubeDailyViewsWithHttpInfo(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default);
        /// <summary>
        ...
        /// <param name="fromDate">Start date in YYYY-MM-DD format. Defaults to 90 days ago, or to the video&#39;s publish date (lifetime) when videoId is provided.  (optional)</param>
        /// <param name="toDate">End date (YYYY-MM-DD). Defaults to 3 days ago, the newest fully finalized day (YouTube finalizes analytics with a ~3-day delay). An explicit toDate is honored up to today: days inside the delay window are provisional and may still be revised by YouTube (see provisionalSince in the response).  (optional)</param>
        /// <param name="startDate">Alias of fromDate, kept for existing callers (optional) (deprecated)</param>
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        /// <returns>YouTubeDemographicsResponse</returns>
        YouTubeDemographicsResponse GetYouTubeDemographics(string accountId, string? videoId = default, string? breakdown = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default);
        ...
        ApiResponse<YouTubeDemographicsResponse> GetYouTubeDemographicsWithHttpInfo(string accountId, string? videoId = default, string? breakdown = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default);
        /// <summary>
        ...
        /// <param name="videoId">The YouTube video ID (e.g., \&quot;dQw4w9WgXcQ\&quot;)</param>
        /// <param name="accountId">The Zernio account ID for the YouTube account</param>
        /// <param name="fromDate">Start date (YYYY-MM-DD). Defaults to the video&#39;s publish date (lifetime curve). (optional)</param>
        /// <param name="toDate">End date (YYYY-MM-DD). Defaults to 3 days ago, the newest fully finalized day (YouTube finalizes analytics with a ~3-day delay). An explicit toDate is honored up to today: days inside the delay window are provisional and may still be revised by YouTube (see provisionalSince in the response).  (optional)</param>
        /// <param name="startDate">Alias of fromDate, kept for existing callers (optional) (deprecated)</param>
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        /// <returns>YouTubeVideoRetentionResponse</returns>
        YouTubeVideoRetentionResponse GetYouTubeVideoRetention(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default);
        ...
        ApiResponse<YouTubeVideoRetentionResponse> GetYouTubeVideoRetentionWithHttpInfo(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default);
        /// <summary>
    ...
    public interface IAnalyticsApiAsync : IApiAccessor
    {
        ...
        /// <param name="profileId">Filter by profile ID (default \&quot;all\&quot;). Must be a valid profile ID or \&quot;all\&quot;. (optional, default to &quot;all&quot;)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AnalyticsDeltaResponse</returns>
        System.Threading.Tasks.Task<AnalyticsDeltaResponse> GetAnalyticsDeltaAsync(string? cursor = default, int? limit = default, string? platform = default, string? profileId = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="profileId">Filter by profile ID (default \&quot;all\&quot;). Must be a valid profile ID or \&quot;all\&quot;. (optional, default to &quot;all&quot;)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AnalyticsDeltaResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<AnalyticsDeltaResponse>> GetAnalyticsDeltaWithHttpInfoAsync(string? cursor = default, int? limit = default, string? platform = default, string? profileId = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Get best times to post
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InstagramAccountInsightsResponse> GetFacebookPageInsightsAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<InstagramAccountInsightsResponse>> GetFacebookPageInsightsWithHttpInfoAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Get Facebook post monetization earnings
        /// </summary>
        /// <remarks>
        ...
        /// <param name="metrics">Comma-separated list of monetization metrics. Defaults to both:   - content_monetization_earnings   - monetization_approximate_earnings  content_monetization_earnings always carries unit \&quot;micro_amount\&quot; plus an ISO 4217 \&quot;currency\&quot;. monetization_approximate_earnings is always a bare number, so its unit is \&quot;unspecified\&quot; and its \&quot;currency\&quot; is null. The two are on different scales and are not comparable to each other. Any other metric name is rejected with 400.  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FacebookPostEarningsResponse</returns>
        System.Threading.Tasks.Task<FacebookPostEarningsResponse> GetFacebookPostEarningsAsync(string accountId, string postId, string? metrics = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="metrics">Comma-separated list of monetization metrics. Defaults to both:   - content_monetization_earnings   - monetization_approximate_earnings  content_monetization_earnings always carries unit \&quot;micro_amount\&quot; plus an ISO 4217 \&quot;currency\&quot;. monetization_approximate_earnings is always a bare number, so its unit is \&quot;unspecified\&quot; and its \&quot;currency\&quot; is null. The two are on different scales and are not comparable to each other. Any other metric name is rejected with 400.  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FacebookPostEarningsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<FacebookPostEarningsResponse>> GetFacebookPostEarningsWithHttpInfoAsync(string accountId, string postId, string? metrics = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Get Facebook post reactions
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GetGoogleBusinessPerformance200Response> GetGoogleBusinessPerformanceAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetGoogleBusinessPerformance200Response>> GetGoogleBusinessPerformanceWithHttpInfoAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Get Google Business Profile search keywords
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstagramAccountInsightsResponse</returns>
        System.Threading.Tasks.Task<InstagramAccountInsightsResponse> GetInstagramAccountInsightsAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, string? breakdown = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstagramAccountInsightsResponse</returns>
        System.Threading.Tasks.Task<InstagramAccountInsightsResponse> GetInstagramFollowerHistoryAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GetLinkedInAggregateAnalytics200Response> GetLinkedInAggregateAnalyticsAsync(string accountId, string? aggregation = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, string? metrics = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetLinkedInAggregateAnalytics200Response>> GetLinkedInAggregateAnalyticsWithHttpInfoAsync(string accountId, string? aggregation = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, string? metrics = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Get LinkedIn org analytics
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstagramAccountInsightsResponse</returns>
        System.Threading.Tasks.Task<InstagramAccountInsightsResponse> GetLinkedInOrgAggregateAnalyticsAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InstagramAccountInsightsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<InstagramAccountInsightsResponse>> GetLinkedInOrgAggregateAnalyticsWithHttpInfoAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Get LinkedIn post stats
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstagramAccountInsightsResponse</returns>
        System.Threading.Tasks.Task<InstagramAccountInsightsResponse> GetTikTokAccountInsightsAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InstagramAccountInsightsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<InstagramAccountInsightsResponse>> GetTikTokAccountInsightsWithHttpInfoAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Get YouTube channel insights
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstagramAccountInsightsResponse</returns>
        System.Threading.Tasks.Task<InstagramAccountInsightsResponse> GetYouTubeChannelInsightsAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InstagramAccountInsightsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<InstagramAccountInsightsResponse>> GetYouTubeChannelInsightsWithHttpInfoAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Get YouTube daily views
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<YouTubeDailyViewsResponse> GetYouTubeDailyViewsAsync(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<YouTubeDailyViewsResponse>> GetYouTubeDailyViewsWithHttpInfoAsync(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Get YouTube demographics
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<YouTubeDemographicsResponse> GetYouTubeDemographicsAsync(string accountId, string? videoId = default, string? breakdown = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<YouTubeVideoRetentionResponse> GetYouTubeVideoRetentionAsync(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<YouTubeVideoRetentionResponse>> GetYouTubeVideoRetentionWithHttpInfoAsync(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Sync an external post
        /// </summary>
        /// <remarks>
    ...
    public partial class AnalyticsApi : IDisposable, IAnalyticsApi
    {
        ...
        /// <param name="profileId">Filter by profile ID (default \&quot;all\&quot;). Must be a valid profile ID or \&quot;all\&quot;. (optional, default to &quot;all&quot;)</param>
        /// <returns>AnalyticsDeltaResponse</returns>
        public AnalyticsDeltaResponse GetAnalyticsDelta(string? cursor = default, int? limit = default, string? platform = default, string? profileId = default)
        {
            Zernio.Client.ApiResponse<AnalyticsDeltaResponse> localVarResponse = GetAnalyticsDeltaWithHttpInfo(cursor, limit, platform, profileId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="profileId">Filter by profile ID (default \&quot;all\&quot;). Must be a valid profile ID or \&quot;all\&quot;. (optional, default to &quot;all&quot;)</param>
        /// <returns>ApiResponse of AnalyticsDeltaResponse</returns>
        public Zernio.Client.ApiResponse<AnalyticsDeltaResponse> GetAnalyticsDeltaWithHttpInfo(string? cursor = default, int? limit = default, string? platform = default, string? profileId = default)
        {
            Zernio.Client.RequestOptions localVarRequestOptions = new Zernio.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<AnalyticsDeltaResponse>("/v1/analytics/delta", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetAnalyticsDelta", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AnalyticsDeltaResponse</returns>
        public async System.Threading.Tasks.Task<AnalyticsDeltaResponse> GetAnalyticsDeltaAsync(string? cursor = default, int? limit = default, string? platform = default, string? profileId = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<AnalyticsDeltaResponse> localVarResponse = await GetAnalyticsDeltaWithHttpInfoAsync(cursor, limit, platform, profileId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AnalyticsDeltaResponse)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<AnalyticsDeltaResponse>> GetAnalyticsDeltaWithHttpInfoAsync(string? cursor = default, int? limit = default, string? platform = default, string? profileId = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<AnalyticsDeltaResponse>("/v1/analytics/delta", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="metricType">\&quot;total_value\&quot; (default) returns aggregated totals only. \&quot;time_series\&quot; returns daily values in the \&quot;values\&quot; array.  (optional, default to total_value)</param>
        /// <returns>InstagramAccountInsightsResponse</returns>
        public InstagramAccountInsightsResponse GetFacebookPageInsights(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default)
        {
            Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> localVarResponse = GetFacebookPageInsightsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType);
            return localVarResponse.Data;
        }
        ...
        /// <param name="metricType">\&quot;total_value\&quot; (default) returns aggregated totals only. \&quot;time_series\&quot; returns daily values in the \&quot;values\&quot; array.  (optional, default to total_value)</param>
        /// <returns>ApiResponse of InstagramAccountInsightsResponse</returns>
        public Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> GetFacebookPageInsightsWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstagramAccountInsightsResponse</returns>
        public async System.Threading.Tasks.Task<InstagramAccountInsightsResponse> GetFacebookPageInsightsAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> localVarResponse = await GetFacebookPageInsightsWithHttpInfoAsync(accountId, metrics, fromDate, toDate, since, until, metricType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <summary>
        /// Get Facebook post monetization earnings Returns lifetime monetization earnings for ONE Facebook post, read live from Meta on every request. Requires the Analytics add-on.  Earnings are CUMULATIVE since the post was published, not earnings within a date range, so this endpoint takes no since/until and the totals must not be summed across dates or across posts. Page-level daily earnings live on /v1/analytics/facebook/page-insights.  A post on a Page that is not enrolled in monetization, or that earned nothing, returns \&quot;total\&quot;: 0 rather than an error: Meta does not distinguish the two. A metric Meta returned no bucket for at all is reported in \&quot;unavailableMetrics\&quot; and omitted from \&quot;metrics\&quot;, never as a 0.  Amounts are the platform&#39;s raw numbers in the stated \&quot;unit\&quot; and are never rescaled by Zernio. Breakdown dimensions are not exposed and a \&quot;breakdown\&quot; param is rejected with 400. So are \&quot;since\&quot;, \&quot;until\&quot;, \&quot;period\&quot;, and \&quot;metricType\&quot;: scoping this endpoint to a window is not possible, and silently returning the lifetime total for one would let a caller sum a year of weekly requests into a figure ~52x the post&#39;s real earnings. 
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accountId">The Zernio SocialAccount ID for the connected Facebook Page.</param>
        /// <param name="postId">The platform post ID, exactly as returned in platformAnalytics[].platformPostId by /v1/analytics: \&quot;{pageId}_{postId}\&quot;, or the bare video ID for Reels. </param>
        /// <param name="metrics">Comma-separated list of monetization metrics. Defaults to both:   - content_monetization_earnings   - monetization_approximate_earnings  content_monetization_earnings always carries unit \&quot;micro_amount\&quot; plus an ISO 4217 \&quot;currency\&quot;. monetization_approximate_earnings is always a bare number, so its unit is \&quot;unspecified\&quot; and its \&quot;currency\&quot; is null. The two are on different scales and are not comparable to each other. Any other metric name is rejected with 400.  (optional)</param>
        /// <returns>FacebookPostEarningsResponse</returns>
        public FacebookPostEarningsResponse GetFacebookPostEarnings(string accountId, string postId, string? metrics = default)
        {
            Zernio.Client.ApiResponse<FacebookPostEarningsResponse> localVarResponse = GetFacebookPostEarningsWithHttpInfo(accountId, postId, metrics);
            return localVarResponse.Data;
        }
        ...
        /// <param name="metrics">Comma-separated list of monetization metrics. Defaults to both:   - content_monetization_earnings   - monetization_approximate_earnings  content_monetization_earnings always carries unit \&quot;micro_amount\&quot; plus an ISO 4217 \&quot;currency\&quot;. monetization_approximate_earnings is always a bare number, so its unit is \&quot;unspecified\&quot; and its \&quot;currency\&quot; is null. The two are on different scales and are not comparable to each other. Any other metric name is rejected with 400.  (optional)</param>
        /// <returns>ApiResponse of FacebookPostEarningsResponse</returns>
        public Zernio.Client.ApiResponse<FacebookPostEarningsResponse> GetFacebookPostEarningsWithHttpInfo(string accountId, string postId, string? metrics = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'accountId' when calling AnalyticsApi->GetFacebookPostEarnings");

            // verify the required parameter 'postId' is set
            if (postId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'postId' when calling AnalyticsApi->GetFacebookPostEarnings");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<FacebookPostEarningsResponse>("/v1/analytics/facebook/post-earnings", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetFacebookPostEarnings", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FacebookPostEarningsResponse</returns>
        public async System.Threading.Tasks.Task<FacebookPostEarningsResponse> GetFacebookPostEarningsAsync(string accountId, string postId, string? metrics = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<FacebookPostEarningsResponse> localVarResponse = await GetFacebookPostEarningsWithHttpInfoAsync(accountId, postId, metrics, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FacebookPostEarningsResponse)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<FacebookPostEarningsResponse>> GetFacebookPostEarningsWithHttpInfoAsync(string accountId, string postId, string? metrics = default, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'accountId' when calling AnalyticsApi->GetFacebookPostEarnings");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<FacebookPostEarningsResponse>("/v1/analytics/facebook/post-earnings", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Get follower stats Returns follower count history and growth metrics for connected accounts. Requires analytics add-on subscription. Follower counts are refreshed once per day. 
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accountIds">Comma-separated list of account IDs (optional, defaults to all user&#39;s accounts) (optional)</param>
        /// <param name="profileId">Filter by profile ID (optional)</param>
        ...
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        /// <returns>GetGoogleBusinessPerformance200Response</returns>
        public GetGoogleBusinessPerformance200Response GetGoogleBusinessPerformance(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default)
        {
            Zernio.Client.ApiResponse<GetGoogleBusinessPerformance200Response> localVarResponse = GetGoogleBusinessPerformanceWithHttpInfo(accountId, metrics, fromDate, toDate, startDate, endDate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        /// <returns>ApiResponse of GetGoogleBusinessPerformance200Response</returns>
        public Zernio.Client.ApiResponse<GetGoogleBusinessPerformance200Response> GetGoogleBusinessPerformanceWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetGoogleBusinessPerformance200Response</returns>
        public async System.Threading.Tasks.Task<GetGoogleBusinessPerformance200Response> GetGoogleBusinessPerformanceAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<GetGoogleBusinessPerformance200Response> localVarResponse = await GetGoogleBusinessPerformanceWithHttpInfoAsync(accountId, metrics, fromDate, toDate, startDate, endDate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="breakdown">Breakdown dimension (only valid with metricType&#x3D;total_value). Valid values depend on the metric: media_product_type, follow_type, follower_type, contact_button_type.  (optional)</param>
        /// <returns>InstagramAccountInsightsResponse</returns>
        public InstagramAccountInsightsResponse GetInstagramAccountInsights(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, string? breakdown = default)
        {
            Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> localVarResponse = GetInstagramAccountInsightsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, breakdown);
            return localVarResponse.Data;
        }
        ...
        /// <param name="breakdown">Breakdown dimension (only valid with metricType&#x3D;total_value). Valid values depend on the metric: media_product_type, follow_type, follower_type, contact_button_type.  (optional)</param>
        /// <returns>ApiResponse of InstagramAccountInsightsResponse</returns>
        public Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> GetInstagramAccountInsightsWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, string? breakdown = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
        ...
        {
            Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> localVarResponse = await GetInstagramAccountInsightsWithHttpInfoAsync(accountId, metrics, fromDate, toDate, since, until, metricType, breakdown, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="metricType">\&quot;total_value\&quot; returns aggregated totals (latest for follower_count, sum for gained/lost). \&quot;time_series\&quot; returns per-day values in the \&quot;values\&quot; array.  (optional, default to total_value)</param>
        /// <returns>InstagramAccountInsightsResponse</returns>
        public InstagramAccountInsightsResponse GetInstagramFollowerHistory(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default)
        {
            Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> localVarResponse = GetInstagramFollowerHistoryWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType);
            return localVarResponse.Data;
        }
        ...
        /// <param name="metricType">\&quot;total_value\&quot; returns aggregated totals (latest for follower_count, sum for gained/lost). \&quot;time_series\&quot; returns per-day values in the \&quot;values\&quot; array.  (optional, default to total_value)</param>
        /// <returns>ApiResponse of InstagramAccountInsightsResponse</returns>
        public Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> GetInstagramFollowerHistoryWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstagramAccountInsightsResponse</returns>
        public async System.Threading.Tasks.Task<InstagramAccountInsightsResponse> GetInstagramFollowerHistoryAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> localVarResponse = await GetInstagramFollowerHistoryWithHttpInfoAsync(accountId, metrics, fromDate, toDate, since, until, metricType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="metrics">Comma-separated metrics: IMPRESSION, MEMBERS_REACHED, REACTION, COMMENT, RESHARE, POST_SAVE, POST_SEND. Omit for all. (optional)</param>
        /// <returns>GetLinkedInAggregateAnalytics200Response</returns>
        public GetLinkedInAggregateAnalytics200Response GetLinkedInAggregateAnalytics(string accountId, string? aggregation = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, string? metrics = default)
        {
            Zernio.Client.ApiResponse<GetLinkedInAggregateAnalytics200Response> localVarResponse = GetLinkedInAggregateAnalyticsWithHttpInfo(accountId, aggregation, fromDate, toDate, startDate, endDate, metrics);
            return localVarResponse.Data;
        }
        ...
        /// <param name="metrics">Comma-separated metrics: IMPRESSION, MEMBERS_REACHED, REACTION, COMMENT, RESHARE, POST_SAVE, POST_SEND. Omit for all. (optional)</param>
        /// <returns>ApiResponse of GetLinkedInAggregateAnalytics200Response</returns>
        public Zernio.Client.ApiResponse<GetLinkedInAggregateAnalytics200Response> GetLinkedInAggregateAnalyticsWithHttpInfo(string accountId, string? aggregation = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, string? metrics = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetLinkedInAggregateAnalytics200Response</returns>
        public async System.Threading.Tasks.Task<GetLinkedInAggregateAnalytics200Response> GetLinkedInAggregateAnalyticsAsync(string accountId, string? aggregation = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, string? metrics = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<GetLinkedInAggregateAnalytics200Response> localVarResponse = await GetLinkedInAggregateAnalyticsWithHttpInfoAsync(accountId, aggregation, fromDate, toDate, startDate, endDate, metrics, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetLinkedInAggregateAnalytics200Response)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<GetLinkedInAggregateAnalytics200Response>> GetLinkedInAggregateAnalyticsWithHttpInfoAsync(string accountId, string? aggregation = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, string? metrics = default, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'accountId' when calling AnalyticsApi->GetLinkedInAggregateAnalytics");
        ...
        /// <param name="metricType"> (optional, default to total_value)</param>
        /// <returns>InstagramAccountInsightsResponse</returns>
        public InstagramAccountInsightsResponse GetLinkedInOrgAggregateAnalytics(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default)
        {
            Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> localVarResponse = GetLinkedInOrgAggregateAnalyticsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType);
            return localVarResponse.Data;
        }
        ...
        /// <param name="metricType"> (optional, default to total_value)</param>
        /// <returns>ApiResponse of InstagramAccountInsightsResponse</returns>
        public Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> GetLinkedInOrgAggregateAnalyticsWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstagramAccountInsightsResponse</returns>
        public async System.Threading.Tasks.Task<InstagramAccountInsightsResponse> GetLinkedInOrgAggregateAnalyticsAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> localVarResponse = await GetLinkedInOrgAggregateAnalyticsWithHttpInfoAsync(accountId, metrics, fromDate, toDate, since, until, metricType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="metricType">\&quot;total_value\&quot; returns the latest cumulative counter value. \&quot;time_series\&quot; returns daily values joined from AccountStats snapshots.  (optional, default to total_value)</param>
        /// <returns>InstagramAccountInsightsResponse</returns>
        public InstagramAccountInsightsResponse GetTikTokAccountInsights(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default)
        {
            Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> localVarResponse = GetTikTokAccountInsightsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType);
            return localVarResponse.Data;
        }
        ...
        /// <param name="metricType">\&quot;total_value\&quot; returns the latest cumulative counter value. \&quot;time_series\&quot; returns daily values joined from AccountStats snapshots.  (optional, default to total_value)</param>
        /// <returns>ApiResponse of InstagramAccountInsightsResponse</returns>
        public Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> GetTikTokAccountInsightsWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstagramAccountInsightsResponse</returns>
        public async System.Threading.Tasks.Task<InstagramAccountInsightsResponse> GetTikTokAccountInsightsAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> localVarResponse = await GetTikTokAccountInsightsWithHttpInfoAsync(accountId, metrics, fromDate, toDate, since, until, metricType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="metricType">\&quot;total_value\&quot; (default) returns aggregated totals. \&quot;time_series\&quot; returns per-day values in the \&quot;values\&quot; array.  (optional, default to total_value)</param>
        /// <returns>InstagramAccountInsightsResponse</returns>
        public InstagramAccountInsightsResponse GetYouTubeChannelInsights(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default)
        {
            Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> localVarResponse = GetYouTubeChannelInsightsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType);
            return localVarResponse.Data;
        }
        ...
        /// <param name="metricType">\&quot;total_value\&quot; (default) returns aggregated totals. \&quot;time_series\&quot; returns per-day values in the \&quot;values\&quot; array.  (optional, default to total_value)</param>
        /// <returns>ApiResponse of InstagramAccountInsightsResponse</returns>
        public Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> GetYouTubeChannelInsightsWithHttpInfo(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InstagramAccountInsightsResponse</returns>
        public async System.Threading.Tasks.Task<InstagramAccountInsightsResponse> GetYouTubeChannelInsightsAsync(string accountId, string? metrics = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? since = default, DateOnly? until = default, string? metricType = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<InstagramAccountInsightsResponse> localVarResponse = await GetYouTubeChannelInsightsWithHttpInfoAsync(accountId, metrics, fromDate, toDate, since, until, metricType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        /// <returns>YouTubeDailyViewsResponse</returns>
        public YouTubeDailyViewsResponse GetYouTubeDailyViews(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default)
        {
            Zernio.Client.ApiResponse<YouTubeDailyViewsResponse> localVarResponse = GetYouTubeDailyViewsWithHttpInfo(videoId, accountId, fromDate, toDate, startDate, endDate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        /// <returns>ApiResponse of YouTubeDailyViewsResponse</returns>
        public Zernio.Client.ApiResponse<YouTubeDailyViewsResponse> GetYouTubeDailyViewsWithHttpInfo(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of YouTubeDailyViewsResponse</returns>
        public async System.Threading.Tasks.Task<YouTubeDailyViewsResponse> GetYouTubeDailyViewsAsync(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<YouTubeDailyViewsResponse> localVarResponse = await GetYouTubeDailyViewsWithHttpInfoAsync(videoId, accountId, fromDate, toDate, startDate, endDate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (YouTubeDailyViewsResponse)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<YouTubeDailyViewsResponse>> GetYouTubeDailyViewsWithHttpInfoAsync(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'videoId' is set
            if (videoId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'videoId' when calling AnalyticsApi->GetYouTubeDailyViews");
        ...
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        /// <returns>YouTubeDemographicsResponse</returns>
        public YouTubeDemographicsResponse GetYouTubeDemographics(string accountId, string? videoId = default, string? breakdown = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default)
        {
            Zernio.Client.ApiResponse<YouTubeDemographicsResponse> localVarResponse = GetYouTubeDemographicsWithHttpInfo(accountId, videoId, breakdown, fromDate, toDate, startDate, endDate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        /// <returns>ApiResponse of YouTubeDemographicsResponse</returns>
        public Zernio.Client.ApiResponse<YouTubeDemographicsResponse> GetYouTubeDemographicsWithHttpInfo(string accountId, string? videoId = default, string? breakdown = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default)
        {
            // verify the required parameter 'accountId' is set
            if (accountId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of YouTubeDemographicsResponse</returns>
        public async System.Threading.Tasks.Task<YouTubeDemographicsResponse> GetYouTubeDemographicsAsync(string accountId, string? videoId = default, string? breakdown = default, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<YouTubeDemographicsResponse> localVarResponse = await GetYouTubeDemographicsWithHttpInfoAsync(accountId, videoId, breakdown, fromDate, toDate, startDate, endDate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        /// <returns>YouTubeVideoRetentionResponse</returns>
        public YouTubeVideoRetentionResponse GetYouTubeVideoRetention(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default)
        {
            Zernio.Client.ApiResponse<YouTubeVideoRetentionResponse> localVarResponse = GetYouTubeVideoRetentionWithHttpInfo(videoId, accountId, fromDate, toDate, startDate, endDate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="endDate">Alias of toDate, kept for existing callers (optional) (deprecated)</param>
        /// <returns>ApiResponse of YouTubeVideoRetentionResponse</returns>
        public Zernio.Client.ApiResponse<YouTubeVideoRetentionResponse> GetYouTubeVideoRetentionWithHttpInfo(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default)
        {
            // verify the required parameter 'videoId' is set
            if (videoId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of YouTubeVideoRetentionResponse</returns>
        public async System.Threading.Tasks.Task<YouTubeVideoRetentionResponse> GetYouTubeVideoRetentionAsync(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<YouTubeVideoRetentionResponse> localVarResponse = await GetYouTubeVideoRetentionWithHttpInfoAsync(videoId, accountId, fromDate, toDate, startDate, endDate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (YouTubeVideoRetentionResponse)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<YouTubeVideoRetentionResponse>> GetYouTubeVideoRetentionWithHttpInfoAsync(string videoId, string accountId, DateOnly? fromDate = default, DateOnly? toDate = default, DateOnly? startDate = default, DateOnly? endDate = default, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'videoId' is set
            if (videoId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'videoId' when calling AnalyticsApi->GetYouTubeVideoRetention");
