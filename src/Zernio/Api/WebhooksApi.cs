...
namespace Zernio.Api
{
    ...
    public interface IWebhooksApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="webhookId">Webhook ID to delete, the same name the other /v1/webhooks operations use (logs, redeliver, test). Required unless the deprecated &#x60;id&#x60; is sent instead. (optional)</param>
        /// <param name="id">Alias of webhookId, kept for existing callers (optional) (deprecated)</param>
        /// <returns>UpdateYoutubeDefaultPlaylist200Response</returns>
        UpdateYoutubeDefaultPlaylist200Response DeleteWebhookSettings(string? webhookId = default, string? id = default);
        ...
        ApiResponse<UpdateYoutubeDefaultPlaylist200Response> DeleteWebhookSettingsWithHttpInfo(string? webhookId = default, string? id = default);
        /// <summary>
    ...
    public interface IWebhooksApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<UpdateYoutubeDefaultPlaylist200Response> DeleteWebhookSettingsAsync(string? webhookId = default, string? id = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<UpdateYoutubeDefaultPlaylist200Response>> DeleteWebhookSettingsWithHttpInfoAsync(string? webhookId = default, string? id = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// List webhook delivery logs
        /// </summary>
        /// <remarks>
    ...
    public partial class WebhooksApi : IDisposable, IWebhooksApi
    {
        ...
        /// <param name="id">Alias of webhookId, kept for existing callers (optional) (deprecated)</param>
        /// <returns>UpdateYoutubeDefaultPlaylist200Response</returns>
        public UpdateYoutubeDefaultPlaylist200Response DeleteWebhookSettings(string? webhookId = default, string? id = default)
        {
            Zernio.Client.ApiResponse<UpdateYoutubeDefaultPlaylist200Response> localVarResponse = DeleteWebhookSettingsWithHttpInfo(webhookId, id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">Alias of webhookId, kept for existing callers (optional) (deprecated)</param>
        /// <returns>ApiResponse of UpdateYoutubeDefaultPlaylist200Response</returns>
        public Zernio.Client.ApiResponse<UpdateYoutubeDefaultPlaylist200Response> DeleteWebhookSettingsWithHttpInfo(string? webhookId = default, string? id = default)
        {
            Zernio.Client.RequestOptions localVarRequestOptions = new Zernio.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UpdateYoutubeDefaultPlaylist200Response</returns>
        public async System.Threading.Tasks.Task<UpdateYoutubeDefaultPlaylist200Response> DeleteWebhookSettingsAsync(string? webhookId = default, string? id = default, System.Threading.CancellationToken cancellationToken = default)
        {
            Zernio.Client.ApiResponse<UpdateYoutubeDefaultPlaylist200Response> localVarResponse = await DeleteWebhookSettingsWithHttpInfoAsync(webhookId, id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UpdateYoutubeDefaultPlaylist200Response)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<UpdateYoutubeDefaultPlaylist200Response>> DeleteWebhookSettingsWithHttpInfoAsync(string? webhookId = default, string? id = default, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <summary>
        /// List webhooks Retrieve all configured webhooks for the authenticated user. Supports up to 50 webhooks per user.
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>GetWebhookSettings200Response</returns>
        ...
        /// <summary>
        /// Update webhook Update an existing webhook configuration. All fields except &#x60;webhookId&#x60; are optional; only provided fields will be updated. &#x60;webhookId&#x60; is the same name the other /v1/webhooks operations use (logs, redeliver, test); the deprecated &#x60;_id&#x60; is still accepted in its place.  When provided, &#x60;name&#x60; must be 1-50 characters, &#x60;url&#x60; must be a valid URL, and &#x60;events&#x60; must contain at least one event. Whitespace is trimmed from &#x60;url&#x60; before validation.  Webhooks are auto-disabled only once the endpoint has had no successful delivery for 3 days AND has either reached 20 consecutive terminal failures (each one an event that exhausted the full retry ladder) or been failing continuously for 3 days. The owner is emailed; re-enable it with &#x60;isActive: true&#x60;.  A restricted (zrk_) API key can only set &#x60;events&#x60; to events whose resource group the key holds; an event outside the key&#39;s groups is rejected with 403. It also cannot widen an existing subscription past its own groups.  &#x60;disabledResourceGroups&#x60; replaces the subscription&#39;s own denylist, which applies to delivery regardless of which key or session created it. Send an empty array to clear it. A restricted key&#39;s own disabled groups are unioned into the stored value on every update, so repointing a legacy unrestricted subscription with a restricted key also narrows it.  Timing: the new denylist applies to every event emitted after the update. Events already queued for delivery when the update landed were filtered against the previous denylist and can still arrive at your endpoint for up to five minutes after they were enqueued, because the delivery worker trusts a five-minute enqueue-time snapshot before re-checking the subscription. Retries beyond that window, dead-letter replays, test fires, and redeliveries are all checked against the current denylist.  &#x60;profileIds&#x60; and &#x60;accountIds&#x60; replace the subscription&#39;s allowlists; an empty array clears one. Ids outside your team are rejected with 404 (&#x60;profile_not_found&#x60;, &#x60;account_not_found&#x60;). 
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="updateWebhookSettingsRequest"></param>
        /// <returns>UpdateWebhookSettings200Response</returns>
