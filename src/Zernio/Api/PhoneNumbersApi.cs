...
namespace Zernio.Api
{
    ...
    public interface IPhoneNumbersApiSync : IApiAccessor
    {
        ...
        /// <param name="prefix">Alias of areaCode, kept for existing callers (optional) (deprecated)</param>
    ...
    public partial class PhoneNumbersApi : IDisposable, IPhoneNumbersApi
    {
        ...
        public Zernio.Client.ApiResponse<SearchAvailablePhoneNumbers200Response> SearchAvailablePhoneNumbersWithHttpInfo(string? country = default, string? numberType = default, string? areaCode = default, string? type = default, string? prefix = default, string? locality = default, string? contains = default, bool? sms = default, int? limit = default, bool? masked = default)
        {
            ...
            if (areaCode != null)
            {
                localVarRequestOptions.QueryParameters.Add(Zernio.Client.ClientUtils.ParameterToMultiMap("", "areaCode", areaCode));
            }
            if (type != null)
            {
