...
namespace Zernio.Api
{
    ...
    public partial class PhoneNumbersApi : IDisposable, IPhoneNumbersApi
    {
        ...
        /// <summary>
        /// Country porting requirements The country-specific information a port-in needs BEYOND the LOA, invoice, and account/address details, such as an ID copy, proof of address, a tax id, or a porting code. Call it after the portability check (which returns each number&#39;s &#x60;countryCode&#x60; and &#x60;phoneNumberType&#x60;), render the fields, and pass the collected values as the create request&#39;s &#x60;requirements&#x60;. US/CA return an empty list. 
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="country">ISO country of the numbers being ported (a supported port-in country).</param>
        /// <param name="numberType">The portability check&#39;s phoneNumberType. Requirements differ by type. (optional, default to local)</param>
        ...
        /// <summary>
        /// Purchase phone number Payment-first: the system provisions a number and auto-assigns it, unless you pass &#x60;phoneNumber&#x60; to buy one exact number from &#x60;GET /v1/phone-numbers/available&#x60;. With usage-based billing active and a payment method on file, the number provisions inline and bills per month on your usage-based invoice (there is no checkout redirect). No payment method on file returns &#x60;402 PAYMENT_REQUIRED&#x60;; a regulated country returns &#x60;202&#x60; with &#x60;status: \&quot;kyc_required\&quot;&#x60; and a &#x60;kycUrl&#x60;.  The monthly price is the one &#x60;GET /v1/phone-numbers/countries&#x60; quotes for that country and &#x60;numberType&#x60; at the time of purchase, and it is stamped on the number: later rate-card changes never move a number you already own.  Requires usage-based billing (the Usage plan). The maximum number of phone numbers is determined by the user&#39;s plan. 
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="purchasePhoneNumberRequest"></param>
        /// <returns>PurchasePhoneNumber200Response</returns>
        ...
        /// <summary>
        /// Release phone number Release a purchased phone number. This will: 1. Disconnect any linked WhatsApp account 2. Decrement the Stripe subscription quantity (or cancel if last number) 3. Release the number from Telnyx 4. Mark the number as released 
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Phone number record ID</param>
        /// <returns>ReleasePhoneNumber200Response</returns>
