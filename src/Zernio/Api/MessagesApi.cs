...
namespace Zernio.Api
{
    ...
    public interface IMessagesApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        /// Send a message in a conversation. Supports text, attachments, quick replies, buttons, templates, and message tags. Attachment and interactive message support varies by platform.  WhatsApp template messages: to send an approved template into this conversation (required when the 24-hour customer-service window is closed), use the &#x60;template&#x60; field with a single element carrying the template reference: &#x60;{ \&quot;elements\&quot;: [{ \&quot;name\&quot;: ..., \&quot;language\&quot;: ..., \&quot;components\&quot;: [...] }] }&#x60;. See the &#x60;template&#x60; field below for the exact shape. To send a template to a phone number you have no conversation with yet, use the create-conversation endpoint (POST /v1/inbox/conversations) instead.  WhatsApp rich interactive messages (list, CTA URL, Flow) are available via the &#x60;interactive&#x60; field. Tap events are delivered through the &#x60;message.received&#x60; webhook with WhatsApp-specific &#x60;metadata&#x60; fields (&#x60;interactiveType&#x60;, &#x60;interactiveId&#x60;, &#x60;flowResponseJson&#x60;, &#x60;flowResponseData&#x60;). 
        /// </remarks>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="conversationId">The conversation ID (id field from list conversations endpoint). This is the platform-specific conversation identifier, not an internal database ID.</param>
    ...
    public partial class MessagesApi : IDisposable, IMessagesApi
    {
        ...
        /// <summary>
        /// Create conversation (send a WhatsApp template) Initiate a new direct message conversation with a specified user. If a conversation already exists with the recipient, the message is added to the existing thread.  Supported platforms: X/Twitter, Bluesky, Reddit, and WhatsApp. Other platforms return PLATFORM_NOT_SUPPORTED.  WhatsApp: this is the endpoint for sending an approved template message to a phone number. Provide templateName, templateLanguage, and templateParams (body variable values), with the recipient phone in participantId. A template is required because WhatsApp does not permit freeform messages to open a conversation; a missing template returns TEMPLATE_REQUIRED. Templates with media headers (image, video, document) are handled automatically: Zernio reads the approved template definition and fills the header at send time. Calling this for a number you already have a thread with simply sends the template into that thread, which also makes it the way to re-engage a contact after the 24-hour customer-service window has closed. Once the recipient replies (opening the 24h window), send freeform messages with the send-message endpoint (POST /v1/inbox/conversations/{conversationId}/messages). Template fields are accepted on the JSON body only, not on multipart requests.  DM eligibility (X/Twitter): Before sending, the endpoint checks if the recipient accepts DMs from your account (via the receives_your_dm field). If not, a 422 error with code DM_NOT_ALLOWED is returned. You can skip this check with skipDmCheck: true if you have already verified eligibility.  X API tier requirement: DM write endpoints require X API Pro tier ($5,000/month) or Enterprise access. This applies to BYOK (Bring Your Own Key) users who provide their own X API credentials.  Rate limits: 200 requests per 15 minutes, 1,000 per 24 hours per user, 15,000 per 24 hours per app (shared across all DM endpoints). 
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="createInboxConversationRequest"></param>
        /// <returns>CreateInboxConversation201Response</returns>
        ...
        {
            Zernio.Client.ApiResponse<SendInboxMessage200Response> localVarResponse = SendInboxMessageWithHttpInfo(conversationId, sendInboxMessageRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sendInboxMessageRequest"></param>
        /// <returns>ApiResponse of SendInboxMessage200Response</returns>
        public Zernio.Client.ApiResponse<SendInboxMessage200Response> SendInboxMessageWithHttpInfo(string conversationId, SendInboxMessageRequest sendInboxMessageRequest)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
        ...
        {
            Zernio.Client.ApiResponse<SendInboxMessage200Response> localVarResponse = await SendInboxMessageWithHttpInfoAsync(conversationId, sendInboxMessageRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SendInboxMessage200Response)</returns>
        public async System.Threading.Tasks.Task<Zernio.Client.ApiResponse<SendInboxMessage200Response>> SendInboxMessageWithHttpInfoAsync(string conversationId, SendInboxMessageRequest sendInboxMessageRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'conversationId' is set
            if (conversationId == null)
                throw new Zernio.Client.ApiException(400, "Missing required parameter 'conversationId' when calling MessagesApi->SendInboxMessage");
