...
namespace Zernio.Api
{
    ...
    public partial class ConversionsApi : IDisposable, IConversionsApi
    {
        ...
        /// <summary>
        /// List associated campaigns LinkedIn-only today. Returns the campaigns currently associated with this conversion rule. Auto-association on rule creation runs once at create time; campaigns created after the rule still need explicit association. 
        /// </summary>
        /// <exception cref="Zernio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accountId"></param>
        /// <param name="destinationId"></param>
