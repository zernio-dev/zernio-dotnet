...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "validatePhoneNumberKycAddress_request")]
    public partial class ValidatePhoneNumberKycAddressRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatePhoneNumberKycAddressRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidatePhoneNumberKycAddressRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatePhoneNumberKycAddressRequest" /> class.
        /// </summary>
        ...
        public ValidatePhoneNumberKycAddressRequest(string country = default, string streetAddress = default, string extendedAddress = default, string locality = default, string administrativeArea = default, string postalCode = default)
        {
            ...
            if (country == null)
            {
                throw new ArgumentNullException("country is a required property for ValidatePhoneNumberKycAddressRequest and cannot be null");
            }
            this.Country = country;
            // to ensure "streetAddress" is required (not null)
            if (streetAddress == null)
            {
                throw new ArgumentNullException("streetAddress is a required property for ValidatePhoneNumberKycAddressRequest and cannot be null");
            }
            this.StreetAddress = streetAddress;
            // to ensure "locality" is required (not null)
            if (locality == null)
            {
                throw new ArgumentNullException("locality is a required property for ValidatePhoneNumberKycAddressRequest and cannot be null");
            }
