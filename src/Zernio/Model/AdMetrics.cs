...
namespace Zernio.Model
{
    ...
    public partial class AdMetrics : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Count of conversion events over the requested date range. Meta: events matching the campaign&#39;s promoted_object.custom_event_type (PURCHASE, LEAD, etc.). Google: the account&#39;s tracked conversions. X and LinkedIn: their reported website/lead conversions (added 2026-07). 0 for non-conversion campaigns or when no events have fired.</value>
