...
namespace Zernio.Model
{
    ...
    public partial class GetAllAccountsHealth200ResponseAccountsInner : IValidatableObject
    {
        ...
        /// <param name="needsReconnect">True when the token is expired or revoked, permissions are missing, the account is inactive, or the platform rejected its stored credentials (the same flag the account listing reports as needsReconnection)..</param>
        ...
        /// </summary>
        /// <value>True when the token is expired or revoked, permissions are missing, the account is inactive, or the platform rejected its stored credentials (the same flag the account listing reports as needsReconnection).</value>
