...
namespace Zernio.Model
{
    ...
    public partial class WebhookPayloadReaction : IValidatableObject
    {
        ...
        public WebhookPayloadReaction(string id = default, EventEnum varEvent = default, WebhookPayloadReactionReaction reaction = default, InboxWebhookConversation conversation = default, InboxWebhookAccount account = default, DateTime timestamp = default)
        {
