...
namespace Zernio.Model
{
    ...
    public partial class AnalyticsSinglePostResponse : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Overall post status. \&quot;partial\&quot; when some platforms published and others failed. While any platform is still pending or processing, the post&#39;s own status is returned instead (usually scheduled or publishing), even if another platform already published.</value>
        ...
        /// <param name="status">Overall post status. \&quot;partial\&quot; when some platforms published and others failed. While any platform is still pending or processing, the post&#39;s own status is returned instead (usually scheduled or publishing), even if another platform already published..</param>
