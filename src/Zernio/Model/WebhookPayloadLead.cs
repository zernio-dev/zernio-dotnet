...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookPayloadLead")]
    public partial class WebhookPayloadLead : IValidatableObject
    {
        /// <summary>
        /// Defines Event
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPayloadLead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookPayloadLead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPayloadLead" /> class.
        /// </summary>
        ...
        public WebhookPayloadLead(string id = default, EventEnum varEvent = default, WebhookPayloadLeadLead lead = default, WebhookPayloadLeadAccount account = default, DateTime timestamp = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for WebhookPayloadLead and cannot be null");
            }
            this.Id = id;
            this.Event = varEvent;
            ...
            if (lead == null)
            {
                throw new ArgumentNullException("lead is a required property for WebhookPayloadLead and cannot be null");
            }
            this.Lead = lead;
            // to ensure "account" is required (not null)
            if (account == null)
            {
                throw new ArgumentNullException("account is a required property for WebhookPayloadLead and cannot be null");
            }
        ...
        public WebhookPayloadLeadLead Lead { get; set; }

        /// <summary>
        /// Gets or Sets Account
        /// </summary>
        [DataMember(Name = "account", IsRequired = true, EmitDefaultValue = true)]
        public WebhookPayloadLeadAccount Account { get; set; }
