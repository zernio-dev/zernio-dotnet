...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createWhatsAppNumberKycLink_request")]
    public partial class CreateWhatsAppNumberKycLinkRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWhatsAppNumberKycLinkRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateWhatsAppNumberKycLinkRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWhatsAppNumberKycLinkRequest" /> class.
        /// </summary>
        ...
        public CreateWhatsAppNumberKycLinkRequest(string profileId = default, string country = default, CreateWhatsAppNumberKycLinkRequestBranding branding = default, string redirectUrl = default)
        {
            // to ensure "profileId" is required (not null)
            if (profileId == null)
            {
                throw new ArgumentNullException("profileId is a required property for CreateWhatsAppNumberKycLinkRequest and cannot be null");
            }
            this.ProfileId = profileId;
            // to ensure "country" is required (not null)
            if (country == null)
            {
                throw new ArgumentNullException("country is a required property for CreateWhatsAppNumberKycLinkRequest and cannot be null");
            }
        ...
        public CreateWhatsAppNumberKycLinkRequestBranding Branding { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateWhatsAppNumberKycLinkRequest {\n");
