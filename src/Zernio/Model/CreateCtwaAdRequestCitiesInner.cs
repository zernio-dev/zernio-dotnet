...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createCtwaAd_request_cities_inner")]
    public partial class CreateCtwaAdRequestCitiesInner : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCtwaAdRequestCitiesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCtwaAdRequestCitiesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCtwaAdRequestCitiesInner" /> class.
        /// </summary>
        ...
        public CreateCtwaAdRequestCitiesInner(string key = default, decimal radius = default, DistanceUnitEnum? distanceUnit = default)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CreateCtwaAdRequestCitiesInner and cannot be null");
            }
            this.Key = key;
            this.Radius = radius;
