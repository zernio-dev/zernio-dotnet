...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookPayloadCallFailed")]
    public partial class WebhookPayloadCallFailed : IValidatableObject
    {
        /// <summary>
        /// Defines Event
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPayloadCallFailed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookPayloadCallFailed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPayloadCallFailed" /> class.
        /// </summary>
        ...
        public WebhookPayloadCallFailed(string id = default, EventEnum varEvent = default, WebhookPayloadCallFailedCall call = default, InboxWebhookAccount account = default, DateTime timestamp = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for WebhookPayloadCallFailed and cannot be null");
            }
            this.Id = id;
            this.Event = varEvent;
            ...
            if (call == null)
            {
                throw new ArgumentNullException("call is a required property for WebhookPayloadCallFailed and cannot be null");
            }
            this.Call = call;
            // to ensure "account" is required (not null)
            if (account == null)
            {
                throw new ArgumentNullException("account is a required property for WebhookPayloadCallFailed and cannot be null");
            }
        ...
        public WebhookPayloadCallFailedCall Call { get; set; }
