...
namespace Zernio.Model
{
    ...
    public partial class UpdateAccountStructuredSnippetsRequest : IValidatableObject
    {
        ...
        public UpdateAccountStructuredSnippetsRequest(string accountId = default, string customerId = default, List<UpdateAccountStructuredSnippetsRequestUpdatesInner> updates = default)
        {
