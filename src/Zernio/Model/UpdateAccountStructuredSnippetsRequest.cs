...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateAccountStructuredSnippets_request")]
    public partial class UpdateAccountStructuredSnippetsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAccountStructuredSnippetsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateAccountStructuredSnippetsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAccountStructuredSnippetsRequest" /> class.
        /// </summary>
        ...
        public UpdateAccountStructuredSnippetsRequest(string accountId = default, string adAccountId = default, string customerId = default, List<UpdateAccountStructuredSnippetsRequestUpdatesInner> updates = default)
        {
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for UpdateAccountStructuredSnippetsRequest and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "updates" is required (not null)
            if (updates == null)
            {
                throw new ArgumentNullException("updates is a required property for UpdateAccountStructuredSnippetsRequest and cannot be null");
            }
        ...
        public List<UpdateAccountStructuredSnippetsRequestUpdatesInner> Updates { get; set; }
