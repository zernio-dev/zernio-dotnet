...
namespace Zernio.Model
{
    ...
    public partial class InlineObject3 : IValidatableObject
    {
        /// <summary>
        ...
        public InlineObject3(string error = default, CodeEnum code = default, ReasonEnum reason = default, string documentationUrl = default, string dashboardUrl = default, InlineObject3Details details = default)
        {
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineObject3 and cannot be null");
            }
            this.Error = error;
            this.Code = code;
            this.Reason = reason;
        ...
        */
        ...
        public InlineObject3Details Details { get; set; }
