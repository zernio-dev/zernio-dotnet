...
namespace Zernio.Model
{
    ...
    public partial class InboxWebhookConversation : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InboxWebhookConversation" /> class.
        /// </summary>
        /// <param name="id">Zernio&#39;s internal conversation id (also the message&#39;s conversationId). Accepted by every /v1/inbox/conversations/{conversationId} endpoint. (required).</param>
        /// <param name="platformConversationId">The platform&#39;s conversation id. This is the &#x60;id&#x60; GET /v1/inbox/conversations returns for the same conversation (on Instagram and Messenger it is the participant&#39;s IGSID / PSID), so key your records on it to match webhooks with list rows. Also accepted by the conversation endpoints. (required).</param>
        ...
        /// </summary>
        /// <value>Zernio&#39;s internal conversation id (also the message&#39;s conversationId). Accepted by every /v1/inbox/conversations/{conversationId} endpoint.</value>
        ...
        /// </summary>
        /// <value>The platform&#39;s conversation id. This is the &#x60;id&#x60; GET /v1/inbox/conversations returns for the same conversation (on Instagram and Messenger it is the participant&#39;s IGSID / PSID), so key your records on it to match webhooks with list rows. Also accepted by the conversation endpoints.</value>
