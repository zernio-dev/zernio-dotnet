...
namespace Zernio.Model
{
    ...
    public partial class GetInboxConversationMessages200ResponseMessagesInner : IValidatableObject
    {
        ...
        /// <param name="isStoryMention">Instagram only. True when the message is the user mentioning the account in their own story. The story itself is the &#x60;share&#x60; attachment with &#x60;originalType: \&quot;story_mention\&quot;&#x60;. Also set on imported history, read off Meta&#39;s &#x60;story.mention&#x60;..</param>
        /// <param name="noRenderableContent">Instagram and Facebook Messenger only. True when Meta withholds the content of this message from the API (its &#x60;is_unsupported&#x60; flag): &#x60;message&#x60; is empty, &#x60;attachments&#x60; is empty, and there is nothing to fetch, now or later. Distinguishes such a message from an ordinary empty one such as a story reply with no text. Absent on other platforms..</param>
        ...
        /// </summary>
        /// <value>The platform&#39;s own message id: the &#x60;wamid&#x60; on WhatsApp, the &#x60;mid&#x60; on Instagram and Facebook Messenger. This is what &#x60;metadata.quotedMessageId&#x60; points at, the value to pass as &#x60;replyTo&#x60; on the platforms that support quote-replies, and the &#x60;{messageId}&#x60; segment of the attachment-resolve URL. Webhooks deliver the same value as &#x60;message.platformMessageId&#x60;; this response has no field by that name. </value>
        ...
        public GetInboxConversationMessages200ResponseMessagesInnerStoryReply StoryReply { get; set; }
        ...
        /// </summary>
        /// <value>Instagram only. True when the message is the user mentioning the account in their own story. The story itself is the &#x60;share&#x60; attachment with &#x60;originalType: \&quot;story_mention\&quot;&#x60;. Also set on imported history, read off Meta&#39;s &#x60;story.mention&#x60;.</value>
        ...
        /// </summary>
        /// <value>Instagram and Facebook Messenger only. True when Meta withholds the content of this message from the API (its &#x60;is_unsupported&#x60; flag): &#x60;message&#x60; is empty, &#x60;attachments&#x60; is empty, and there is nothing to fetch, now or later. Distinguishes such a message from an ordinary empty one such as a story reply with no text. Absent on other platforms.</value>
        ...
        /// </summary>
        /// <value>Platform-specific extras. Free-form, but commonly includes: &#x60;quotedMessageId&#x60; (the &#x60;id&#x60; of the message this one replies to, delivered as &#x60;message.platformMessageId&#x60; on webhooks), &#x60;waInteractive&#x60; (a compact descriptor of WhatsApp interactive content sent: buttons / list / cta_url / flow / location_request), &#x60;metaInteractive&#x60; (outgoing Instagram/Facebook buttons, quickReplies and template, as sent), and for inbound interactive taps &#x60;interactiveType&#x60; / &#x60;interactiveId&#x60;. It can also carry &#x60;source&#x60; (&#x60;whatsapp_business_app&#x60; / &#x60;coexistence_history&#x60; on a WhatsApp Coexistence number, &#x60;bulk-api&#x60; on a POST /v1/whatsapp/bulk send), which is where the message reached us from rather than who produced it: read &#x60;sentVia&#x60; for that. </value>
