...
namespace Zernio.Model
{
    ...
    /// TikTokDryRunVerdict
    /// </summary>
    [DataContract(Name = "TikTokDryRunVerdict")]
    public partial class TikTokDryRunVerdict : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TikTokDryRunVerdict" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TikTokDryRunVerdict() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TikTokDryRunVerdict" /> class.
        /// </summary>
        ...
        public TikTokDryRunVerdict(bool dryRun = default, bool canPublish = default, List<TikTokDryRunVerdictTiktokInner> tiktok = default)
        {
            this.DryRun = dryRun;
            ...
            if (tiktok == null)
            {
                throw new ArgumentNullException("tiktok is a required property for TikTokDryRunVerdict and cannot be null");
            }
            this.Tiktok = tiktok;
        }
        ...
        public List<TikTokDryRunVerdictTiktokInner> Tiktok { get; set; }
