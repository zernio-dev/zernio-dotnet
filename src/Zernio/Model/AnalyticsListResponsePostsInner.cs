...
namespace Zernio.Model
{
    ...
    public partial class AnalyticsListResponsePostsInner : IValidatableObject
    {
        ...
        /// <param name="thumbnailUrl">Cover image URL. Facebook and Instagram covers whose Meta CDN link expired are re-read from Meta and served from Zernio storage, so that URL does not expire and can be cached..</param>
        /// <param name="mediaType">mediaType.</param>
        /// <param name="mediaItems">All media items for this post. Carousel posts contain one entry per slide. Facebook and Instagram images and video covers whose Meta CDN links expired are re-read and served from Zernio storage (non-expiring). Facebook and Instagram video file URLs, and LinkedIn media URLs, stay the platform&#39;s signed links and are refreshed on read once they lapse..</param>
        ...
        /// </summary>
        /// <value>Cover image URL. Facebook and Instagram covers whose Meta CDN link expired are re-read from Meta and served from Zernio storage, so that URL does not expire and can be cached.</value>
        ...
        /// </summary>
        /// <value>All media items for this post. Carousel posts contain one entry per slide. Facebook and Instagram images and video covers whose Meta CDN links expired are re-read and served from Zernio storage (non-expiring). Facebook and Instagram video file URLs, and LinkedIn media URLs, stay the platform&#39;s signed links and are refreshed on read once they lapse.</value>
