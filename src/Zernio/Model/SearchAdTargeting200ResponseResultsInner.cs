...
namespace Zernio.Model
{
    ...
    public partial class SearchAdTargeting200ResponseResultsInner : IValidatableObject
    {
        ...
        public SearchAdTargeting200ResponseResultsInner(string id = default, string name = default, string type = default, List<string> path = default, int? audienceSize = default, string countryCode = default)
        {
        ...
        /// </summary>
        /// <value>ISO-3166 alpha-2 of the country a sub-country geo result (city, region, zip, metro) belongs to, when the platform reports it (Meta does). Useful to know whether a location falls under the EU DSA disclosure rules before creating the ad.</value>
