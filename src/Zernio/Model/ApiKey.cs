...
namespace Zernio.Model
{
    ...
    public partial class ApiKey : IValidatableObject
    {
        ...
        public ApiKey(string id = default, string name = default, string keyPreview = default, DateTime expiresAt = default, DateTime createdAt = default, string key = default, ScopeEnum? scope = ScopeEnum.Full, List<ApiKeyProfileIdsInner> profileIds = default, PermissionEnum? permission = PermissionEnum.ReadWrite, List<DisabledResourceGroupsEnum> disabledResourceGroups = default, ApiKeyCreatedBy createdBy = default)
        {
            this.Id = id;
            this.Name = name;
        ...
        public ApiKeyCreatedBy CreatedBy { get; set; }
