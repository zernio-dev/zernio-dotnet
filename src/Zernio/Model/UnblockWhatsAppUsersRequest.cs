...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "unblockWhatsAppUsers_request")]
    public partial class UnblockWhatsAppUsersRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnblockWhatsAppUsersRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnblockWhatsAppUsersRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnblockWhatsAppUsersRequest" /> class.
        /// </summary>
        ...
        public UnblockWhatsAppUsersRequest(string accountId = default, List<string> users = default)
        {
            ...
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for UnblockWhatsAppUsersRequest and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "users" is required (not null)
            if (users == null)
            {
                throw new ArgumentNullException("users is a required property for UnblockWhatsAppUsersRequest and cannot be null");
            }
            this.Users = users;
        }
        ...
        /// </summary>
        /// <value>Phone numbers (E.164) or WhatsApp user IDs to unblock.</value>
