...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookPayloadCallEnded")]
    public partial class WebhookPayloadCallEnded : IValidatableObject
    {
        /// <summary>
        /// Defines Event
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPayloadCallEnded" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookPayloadCallEnded() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPayloadCallEnded" /> class.
        /// </summary>
        ...
        public WebhookPayloadCallEnded(string id = default, EventEnum varEvent = default, WebhookPayloadCallEndedCall call = default, InboxWebhookAccount account = default, DateTime timestamp = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for WebhookPayloadCallEnded and cannot be null");
            }
            this.Id = id;
            this.Event = varEvent;
            ...
            if (call == null)
            {
                throw new ArgumentNullException("call is a required property for WebhookPayloadCallEnded and cannot be null");
            }
            this.Call = call;
            // to ensure "account" is required (not null)
            if (account == null)
            {
                throw new ArgumentNullException("account is a required property for WebhookPayloadCallEnded and cannot be null");
            }
        ...
        public WebhookPayloadCallEndedCall Call { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebhookPayloadCallEnded {\n");
