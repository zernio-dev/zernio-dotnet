...
namespace Zernio.Model
{
    ...
    public partial class CreateStandaloneAdRequestPromotedObject : IValidatableObject
    {
        ...
        /// <param name="customEventStr">Meta only. Pixel custom-event name to optimise against (Meta&#39;s &#x60;custom_event_str&#x60;), exactly as it appears in Events Manager and in your CAPI payloads (case-sensitive, not uppercased). Requires &#x60;customEventType: OTHER&#x60;, and &#x60;OTHER&#x60; requires this field (400 either way). The same as picking a custom event in Ads Manager&#39;s conversion-event dropdown. For rule-based Custom Conversions use &#x60;customConversionId&#x60; instead. .</param>
        ...
        /// </summary>
        /// <value>Pixel ID. **Meta:** Facebook Pixel ID, required for &#x60;goal: conversions&#x60;. Requires &#x60;customEventType&#x60; alongside it; Meta rejects any promoted_object carrying &#x60;pixel_id&#x60; without &#x60;custom_event_type&#x60; (error_subcode 1885014), even when &#x60;customConversionId&#x60; is also present. **TikTok:** TikTok Pixel ID, required for &#x60;goal: conversions&#x60;. To discover the pixels an ad account can use, call &#x60;GET /v1/accounts/{accountId}/tracking-tags?adAccountId&#x3D;act_...&#x60; (each entry carries &#x60;kind&#x60; and &#x60;ownerAdAccountId&#x60;), or &#x60;GET /v1/accounts/{accountId}/conversion-destinations&#x60;. Note this is a different resource from &#x60;GET /v1/ads/{adId}/tracking-tags&#x60;, which reads an ad&#39;s click-URL params (&#x60;url_tags&#x60;), not pixels. </value>
        ...
        /// </summary>
        /// <value>Meta only. Pixel custom-event name to optimise against (Meta&#39;s &#x60;custom_event_str&#x60;), exactly as it appears in Events Manager and in your CAPI payloads (case-sensitive, not uppercased). Requires &#x60;customEventType: OTHER&#x60;, and &#x60;OTHER&#x60; requires this field (400 either way). The same as picking a custom event in Ads Manager&#39;s conversion-event dropdown. For rule-based Custom Conversions use &#x60;customConversionId&#x60; instead. </value>
        ...
        /// </summary>
        /// <value>Custom Conversion ID, when optimising against one instead of a standard event. Accepted alone by this API, without &#x60;pixelId&#x60; or &#x60;customEventType&#x60;. If &#x60;pixelId&#x60; is also sent, &#x60;customEventType&#x60; is still required on the promoted_object (Meta rejects &#x60;pixel_id&#x60; without &#x60;custom_event_type&#x60;, error_subcode 1885014). </value>
