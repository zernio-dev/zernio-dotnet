...
namespace Zernio.Model
{
    ...
    public partial class CreateInboxConversation429Response : IValidatableObject
    {
        /// <summary>
        /// Defines Code
        /// </summary>
        ...
        public CreateInboxConversation429Response(string error = default, CodeEnum? code = default)
        {
            this.Error = error;
            this.Code = code;
        }
