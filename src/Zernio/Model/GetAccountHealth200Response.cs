...
namespace Zernio.Model
{
    ...
    public partial class GetAccountHealth200Response : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>TikTok only. The TikTok integration the account is connected through: business (TikTok for Business, Accounts API) or developer (the original integration). Absent on other platforms.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum IntegrationLaneEnum
        {
            /// <summary>
        ...
        /// </summary>
        /// <value>TikTok only. The TikTok integration the account is connected through: business (TikTok for Business, Accounts API) or developer (the original integration). Absent on other platforms.</value>
        [DataMember(Name = "integrationLane", EmitDefaultValue = false)]
        public IntegrationLaneEnum? IntegrationLane { get; set; }
        /// <summary>
        ...
        /// <param name="integrationLane">TikTok only. The TikTok integration the account is connected through: business (TikTok for Business, Accounts API) or developer (the original integration). Absent on other platforms..</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IntegrationLane: ").Append(IntegrationLane).Append("\n");
