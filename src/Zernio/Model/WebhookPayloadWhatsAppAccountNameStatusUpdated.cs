...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookPayloadWhatsAppAccountNameStatusUpdated")]
    public partial class WebhookPayloadWhatsAppAccountNameStatusUpdated : IValidatableObject
    {
        /// <summary>
        /// Defines Event
        /// </summary>
        ...
        public enum EventEnum
        {
            ...
            WhatsappAccountNameStatusUpdated = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPayloadWhatsAppAccountNameStatusUpdated" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookPayloadWhatsAppAccountNameStatusUpdated() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPayloadWhatsAppAccountNameStatusUpdated" /> class.
        /// </summary>
        ...
        public WebhookPayloadWhatsAppAccountNameStatusUpdated(string id = default, EventEnum varEvent = default, WebhookPayloadWhatsAppTemplateStatusUpdatedAccount account = default, WebhookPayloadWhatsAppAccountNameStatusUpdatedName name = default, DateTime timestamp = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for WebhookPayloadWhatsAppAccountNameStatusUpdated and cannot be null");
            }
            this.Id = id;
            this.Event = varEvent;
            ...
            if (account == null)
            {
                throw new ArgumentNullException("account is a required property for WebhookPayloadWhatsAppAccountNameStatusUpdated and cannot be null");
            }
            this.Account = account;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for WebhookPayloadWhatsAppAccountNameStatusUpdated and cannot be null");
            }
            this.Name = name;
        ...
        public WebhookPayloadWhatsAppAccountNameStatusUpdatedName Name { get; set; }
