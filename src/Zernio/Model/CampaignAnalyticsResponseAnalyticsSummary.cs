...
namespace Zernio.Model
{
    ...
    public partial class CampaignAnalyticsResponseAnalyticsSummary : IValidatableObject
    {
        ...
        /// <param name="searchImpressionShare">Google only. Date-range ratio, not a percentage. Null when unavailable; Google&#39;s threshold sentinel values are preserved..</param>
        /// <param name="searchBudgetLostImpressionShare">Google only. Date-range ratio, not a percentage. Null when unavailable; Google&#39;s threshold sentinel values are preserved..</param>
        ...
        /// </summary>
        /// <value>Unique people reached in the requested date range. Meta (facebook/instagram) and TikTok: the platform&#39;s own de-duplicated reach for the exact range, fetched live and cached up to ~1 hour (may lag recent delivery; on a transient platform error the value temporarily falls back to a sum of per-day reach, which overcounts people reached on multiple days or by multiple child ads). Because it is de-duplicated, reach is NOT additive on these platforms: neither daily values nor child nodes sum to the range total. LinkedIn: the campaign&#39;s &#x60;approximateMemberReach&#x60;, de-duplicated by LinkedIn per day and then summed over the range here, so it overcounts members reached on more than one day; LinkedIn withholds it below its audience privacy threshold, where it reads 0. Google, X, Pinterest and OpenAI report 0 (reach not synced). Frequency (impressions / reach) is only meaningful for Meta and TikTok.</value>
        ...
        */
        ...
        /// </summary>
        /// <value>Google only. Date-range ratio, not a percentage. Null when unavailable; Google&#39;s threshold sentinel values are preserved.</value>
        [DataMember(Name = "searchImpressionShare", EmitDefaultValue = true)]
        public decimal? SearchImpressionShare { get; set; }

        /// <summary>
        /// Google only. Date-range ratio, not a percentage. Null when unavailable; Google&#39;s threshold sentinel values are preserved.
        /// </summary>
        /// <value>Google only. Date-range ratio, not a percentage. Null when unavailable; Google&#39;s threshold sentinel values are preserved.</value>
        [DataMember(Name = "searchBudgetLostImpressionShare", EmitDefaultValue = true)]
        public decimal? SearchBudgetLostImpressionShare { get; set; }

        /// <summary>
        /// Google only. Date-range ratio, not a percentage. Null when unavailable; Google&#39;s threshold sentinel values are preserved.
        /// </summary>
        /// <value>Google only. Date-range ratio, not a percentage. Null when unavailable; Google&#39;s threshold sentinel values are preserved.</value>
        [DataMember(Name = "searchRankLostImpressionShare", EmitDefaultValue = true)]
        public decimal? SearchRankLostImpressionShare { get; set; }

        /// <summary>
        /// Google only. Date-range ratio, not a percentage. Null when unavailable; Google&#39;s threshold sentinel values are preserved.
        /// </summary>
        /// <value>Google only. Date-range ratio, not a percentage. Null when unavailable; Google&#39;s threshold sentinel values are preserved.</value>
        [DataMember(Name = "searchTopImpressionShare", EmitDefaultValue = true)]
        public decimal? SearchTopImpressionShare { get; set; }

        /// <summary>
        /// Google only. Date-range ratio, not a percentage. Null when unavailable; Google&#39;s threshold sentinel values are preserved.
        /// </summary>
        /// <value>Google only. Date-range ratio, not a percentage. Null when unavailable; Google&#39;s threshold sentinel values are preserved.</value>
        [DataMember(Name = "searchAbsoluteTopImpressionShare", EmitDefaultValue = true)]
        public decimal? SearchAbsoluteTopImpressionShare { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CampaignAnalyticsResponseAnalyticsSummary {\n");
            ...
            sb.Append("  SearchImpressionShare: ").Append(SearchImpressionShare).Append("\n");
            sb.Append("  SearchBudgetLostImpressionShare: ").Append(SearchBudgetLostImpressionShare).Append("\n");
            sb.Append("  SearchRankLostImpressionShare: ").Append(SearchRankLostImpressionShare).Append("\n");
            sb.Append("  SearchTopImpressionShare: ").Append(SearchTopImpressionShare).Append("\n");
            sb.Append("  SearchAbsoluteTopImpressionShare: ").Append(SearchAbsoluteTopImpressionShare).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
