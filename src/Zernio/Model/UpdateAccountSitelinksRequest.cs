...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateAccountSitelinks_request")]
    public partial class UpdateAccountSitelinksRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAccountSitelinksRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateAccountSitelinksRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAccountSitelinksRequest" /> class.
        /// </summary>
        ...
        public UpdateAccountSitelinksRequest(string accountId = default, string adAccountId = default, string customerId = default, List<UpdateAccountSitelinksRequestUpdatesInner> updates = default)
        {
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for UpdateAccountSitelinksRequest and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "updates" is required (not null)
            if (updates == null)
            {
                throw new ArgumentNullException("updates is a required property for UpdateAccountSitelinksRequest and cannot be null");
            }
        ...
        public List<UpdateAccountSitelinksRequestUpdatesInner> Updates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateAccountSitelinksRequest {\n");
