...
namespace Zernio.Model
{
    ...
    public partial class UpdateAccountSitelinksRequest : IValidatableObject
    {
        ...
        public UpdateAccountSitelinksRequest(string accountId = default, string customerId = default, List<UpdateAccountSitelinksRequestUpdatesInner> updates = default)
        {
