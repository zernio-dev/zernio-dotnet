...
namespace Zernio.Model
{
    ...
    public partial class LinkedInPlatformData : IValidatableObject
    {
        ...
        public LinkedInPlatformData(string documentTitle = default, string organizationUrn = default, string firstComment = default, bool disableLinkPreview = default, LinkedInPlatformDataAudience audience = default, string reshareUrl = default, GeoRestriction geoRestriction = default, LinkedInPlatformDataPoll poll = default)
        {
        ...
        public LinkedInPlatformDataAudience Audience { get; set; }
