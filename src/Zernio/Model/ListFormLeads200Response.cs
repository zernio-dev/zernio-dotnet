...
namespace Zernio.Model
{
    ...
    public partial class ListFormLeads200Response : IValidatableObject
    {
        ...
        public ListFormLeads200Response(string status = default, List<ListFormLeads200ResponseLeadsInner> leads = default, GetInboxPostComments200ResponsePagination pagination = default)
        {
            this.Status = status;
            this.Leads = leads;
