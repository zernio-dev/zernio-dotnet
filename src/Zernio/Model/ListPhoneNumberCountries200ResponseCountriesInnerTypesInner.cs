...
namespace Zernio.Model
{
    ...
    public partial class ListPhoneNumberCountries200ResponseCountriesInnerTypesInner : IValidatableObject
    {
        ...
        /// <param name="whatsappAvailable">False for toll_free (WhatsApp does not reliably register toll-free numbers) and for pairs Meta refuses, such as Chilean local (+56 2)..</param>
        ...
        /// </summary>
        /// <value>False for toll_free (WhatsApp does not reliably register toll-free numbers) and for pairs Meta refuses, such as Chilean local (+56 2).</value>
