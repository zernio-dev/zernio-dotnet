...
namespace Zernio.Model
{
    ...
    public partial class AdTreeCampaign : IValidatableObject
    {
        ...
        /// <param name="platformCampaignStatus">Raw platform-level campaign status (Meta &#x60;effective_status&#x60;: ACTIVE, PAUSED, DELETED, ARCHIVED, IN_PROCESS, WITH_ISSUES; ChatGPT (OpenAI): the campaign&#39;s own switch, active / paused / archived, independent of the delivery &#x60;status&#x60;). Distinct from per-ad &#x60;platformStatus&#x60;..</param>
        ...
        /// </summary>
        /// <value>Raw platform-level campaign status (Meta &#x60;effective_status&#x60;: ACTIVE, PAUSED, DELETED, ARCHIVED, IN_PROCESS, WITH_ISSUES; ChatGPT (OpenAI): the campaign&#39;s own switch, active / paused / archived, independent of the delivery &#x60;status&#x60;). Distinct from per-ad &#x60;platformStatus&#x60;.</value>
        ...
        /// </summary>
        /// <value>Representative bid for the campaign, bubbled up from the top-spending ad set (whole currency units). Meta: populated when the ad-set bidStrategy is LOWEST_COST_WITH_BID_CAP or COST_CAP. LinkedIn: the campaign unitCost, which has no bidStrategy gate and where 0 is a real, delivery-stopping value rather than unset.</value>
