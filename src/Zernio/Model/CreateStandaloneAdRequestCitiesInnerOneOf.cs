...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createStandaloneAd_request_cities_inner_oneOf")]
    public partial class CreateStandaloneAdRequestCitiesInnerOneOf : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStandaloneAdRequestCitiesInnerOneOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateStandaloneAdRequestCitiesInnerOneOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStandaloneAdRequestCitiesInnerOneOf" /> class.
        /// </summary>
        /// <param name="key">City id from /v1/ads/targeting/search results (Meta city key, Google geo target constant id, TikTok location id). (required).</param>
        ...
        public CreateStandaloneAdRequestCitiesInnerOneOf(string key = default, decimal radius = default, DistanceUnitEnum? distanceUnit = default)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CreateStandaloneAdRequestCitiesInnerOneOf and cannot be null");
            }
            this.Key = key;
            this.Radius = radius;
        ...
        /// </summary>
        /// <value>City id from /v1/ads/targeting/search results (Meta city key, Google geo target constant id, TikTok location id).</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateStandaloneAdRequestCitiesInnerOneOf {\n");
