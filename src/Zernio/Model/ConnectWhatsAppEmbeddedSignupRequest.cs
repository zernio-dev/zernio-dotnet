...
namespace Zernio.Model
{
    ...
    public partial class ConnectWhatsAppEmbeddedSignupRequest : IValidatableObject
    {
        ...
        /// <param name="redirectUrl2">Hosted signup page only. When present, the response also carries &#x60;redirectUrl&#x60;, the URL the user should land on, with the outcome mapped exactly like the redirect flow (success params, or &#x60;error&#x60; and &#x60;platform&#x60; with the same values). Must be an absolute http(s) URL or a custom app scheme..</param>
        /// <param name="redirectUrl">Alias of redirect_url, kept for existing callers.</param>
        ...
        public ConnectWhatsAppEmbeddedSignupRequest(string code = default, string profileId = default, string wabaId = default, string phoneNumberId = default, bool isCoexistence = default, string expectedPhoneNumber = default, string redirectUrl2 = default, string redirectUrl = default, bool echoConnectToken = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RedirectUrl2: ").Append(RedirectUrl2).Append("\n");
