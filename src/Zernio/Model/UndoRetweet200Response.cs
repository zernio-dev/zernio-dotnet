...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "undoRetweet_200_response")]
    public partial class UndoRetweet200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UndoRetweet200Response" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="tweetId">tweetId.</param>
        /// <param name="retweeted">retweeted.</param>
        /// <param name="platform">platform.</param>
        public UndoRetweet200Response(string status = default, string tweetId = default, bool retweeted = default, string platform = default)
        {
            this.Status = status;
