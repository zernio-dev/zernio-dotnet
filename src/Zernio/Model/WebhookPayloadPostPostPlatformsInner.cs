...
namespace Zernio.Model
{
    ...
    public partial class WebhookPayloadPostPostPlatformsInner : IValidatableObject
    {
        ...
        public WebhookPayloadPostPostPlatformsInner(string platform = default, string status = default, string accountId = default, string platformPostId = default, string publishedUrl = default, string error = default, PostPlatformError platformError = default)
        {
