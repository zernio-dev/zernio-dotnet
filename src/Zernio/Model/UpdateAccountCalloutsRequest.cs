...
{
    /// <summary>
    /// UpdateAccountCalloutsRequest
    /// </summary>
    [DataContract(Name = "updateAccountCallouts_request")]
    public partial class UpdateAccountCalloutsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAccountCalloutsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateAccountCalloutsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAccountCalloutsRequest" /> class.
        /// </summary>
        ...
        public UpdateAccountCalloutsRequest(string accountId = default, string adAccountId = default, string customerId = default, List<UpdateAccountCalloutsRequestUpdatesInner> updates = default)
        {
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for UpdateAccountCalloutsRequest and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "updates" is required (not null)
            if (updates == null)
            {
                throw new ArgumentNullException("updates is a required property for UpdateAccountCalloutsRequest and cannot be null");
            }
        ...
        public List<UpdateAccountCalloutsRequestUpdatesInner> Updates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateAccountCalloutsRequest {\n");
