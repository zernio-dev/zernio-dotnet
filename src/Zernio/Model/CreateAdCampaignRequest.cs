...
namespace Zernio.Model
{
    ...
    public partial class CreateAdCampaignRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Google only (400 elsewhere). Written on the new campaign.</value>
        ...
        /// <param name="validateOnly">Meta only. Runs campaign validation without creating or persisting a campaign; Idempotency-Key storage is bypassed. Returns HTTP 200 with validateOnly true and status VALIDATED. &#x60;true&#x60; on any other platform returns 501 &#x60;feature_not_available&#x60; (same as POST /v1/ads/create); &#x60;false&#x60; is ignored..</param>
        ...
        /// <param name="locationTargetingType">Google only (400 elsewhere). Written on the new campaign..</param>
        ...
        public CreateAdCampaignRequest(string accountId = default, string adAccountId = default, string name = default, GoalEnum goal = default, bool isSkadnetworkAttribution = default, AdPromotedObject promotedObject = default, BuyingTypeEnum? buyingType = default, bool validateOnly = default, List<SpecialAdCategoriesEnum> specialAdCategories = default, decimal budgetAmount = default, BudgetTypeEnum? budgetType = default, StatusEnum? status = StatusEnum.PAUSED, GoogleLocationTargetingType? locationTargetingType = default, BidStrategyEnum? bidStrategy = default, decimal bidAmount = default, decimal roasAverageFloor = default, string portfolioBidStrategyId = default)
        {
        ...
        /// </summary>
        /// <value>Meta only. Runs campaign validation without creating or persisting a campaign; Idempotency-Key storage is bypassed. Returns HTTP 200 with validateOnly true and status VALIDATED. &#x60;true&#x60; on any other platform returns 501 &#x60;feature_not_available&#x60; (same as POST /v1/ads/create); &#x60;false&#x60; is ignored.</value>
