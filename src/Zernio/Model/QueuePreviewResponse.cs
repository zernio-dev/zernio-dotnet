...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QueuePreviewResponse")]
    public partial class QueuePreviewResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueuePreviewResponse" /> class.
        /// </summary>
        ...
        public QueuePreviewResponse(string profileId = default, string queueId = default, string queueName = default, int count = default, List<DateTime> slots = default)
        {
