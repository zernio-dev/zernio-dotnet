...
namespace Zernio.Model
{
    ...
    public partial class AssignGoogleBusinessLocation200ResponseAccount : IValidatableObject
    {
        ...
        /// <param name="selectedLocationId">Bare Google Business Profile location id (digits only). Combine with the Google Business Profile account id as accounts/{gbpAccountId}/locations/{selectedLocationId} to form the location resource names that gmb-reviews/batch expects in locationNames..</param>
        ...
        /// </summary>
        /// <value>Bare Google Business Profile location id (digits only). Combine with the Google Business Profile account id as accounts/{gbpAccountId}/locations/{selectedLocationId} to form the location resource names that gmb-reviews/batch expects in locationNames.</value>
