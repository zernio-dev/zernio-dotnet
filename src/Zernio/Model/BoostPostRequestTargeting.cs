...
namespace Zernio.Model
{
    ...
    public partial class BoostPostRequestTargeting : IValidatableObject
    {
        ...
        public BoostPostRequestTargeting(int ageMin = default, int ageMax = default, GenderEnum? gender = default, List<string> languages = default, List<string> countries = default, List<UpdateCampaignTargetingRequestTargetingLocationsOneOfRegionsInnerOneOf> regions = default, List<BoostPostRequestTargetingCitiesInner> cities = default, List<UpdateCampaignTargetingRequestTargetingLocationsOneOfRegionsInnerOneOf> zips = default, List<UpdateCampaignTargetingRequestTargetingLocationsOneOfRegionsInnerOneOf> metros = default, List<BoostPostRequestTargetingCustomLocationsInner> customLocations = default, List<UpdateAdRequestTargetingInterestsInner> interests = default, AdvantageAudienceEnum? advantageAudience = default)
        {
            this.AgeMin = ageMin;
            this.AgeMax = ageMax;
            this.Gender = gender;
