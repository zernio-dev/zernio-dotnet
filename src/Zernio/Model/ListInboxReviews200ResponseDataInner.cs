...
namespace Zernio.Model
{
    ...
    public partial class ListInboxReviews200ResponseDataInner : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Facebook recommendation: positive means recommends, negative means does not recommend. Null or absent when unavailable; absent for other platforms. Independent of the numeric rating.</value>
        ...
        /// <param name="recommendationType">Facebook recommendation: positive means recommends, negative means does not recommend. Null or absent when unavailable; absent for other platforms. Independent of the numeric rating..</param>
