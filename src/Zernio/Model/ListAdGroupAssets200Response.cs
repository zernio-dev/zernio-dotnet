...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listAdGroupAssets_200_response")]
    public partial class ListAdGroupAssets200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAdGroupAssets200Response" /> class.
        /// </summary>
        ...
        public ListAdGroupAssets200Response(string adGroupId = default, List<ListAdGroupAssets200ResponseSitelinksInner> sitelinks = default, List<ListAdGroupAssets200ResponseCalloutsInner> callouts = default, List<ListAdGroupAssets200ResponseStructuredSnippetsInner> structuredSnippets = default, DateTime? cachedAt = default, bool stale = default)
        {
        ...
        public List<ListAdGroupAssets200ResponseSitelinksInner> Sitelinks { get; set; }

        /// <summary>
        /// Gets or Sets Callouts
        /// </summary>
        [DataMember(Name = "callouts", EmitDefaultValue = false)]
        public List<ListAdGroupAssets200ResponseCalloutsInner> Callouts { get; set; }

        /// <summary>
        /// Gets or Sets StructuredSnippets
        /// </summary>
        [DataMember(Name = "structuredSnippets", EmitDefaultValue = false)]
        public List<ListAdGroupAssets200ResponseStructuredSnippetsInner> StructuredSnippets { get; set; }
