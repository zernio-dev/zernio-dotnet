...
namespace Zernio.Model
{
    ...
    public partial class ErrorResponse : IValidatableObject
    {
        ...
        public ErrorResponse(string error = default, TypeEnum? type = default, string code = default, string param = default, string platform = default, Dictionary<string, Object> platformError = default, ErrorResponseDetails details = default)
        {
            this.Error = error;
            this.Type = type;
            this.Code = code;
