...
namespace Zernio.Model
{
    ...
    public partial class BoostPostRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Goes together with budgetAmount. lifetime requires schedule.endDate.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Google only (400 elsewhere). Written on the campaign the boost creates.</value>
        ...
        /// </summary>
        /// <value>Meta, TikTok, LinkedIn, and Google. Publish state of the created entities. Omitted or ACTIVE publishes live (default); PAUSED creates them paused so you can review before they spend. On Meta a new campaign stays paused until explicitly activated; an attached ad is itself paused. On Google the pause is held on the campaign the boost creates (ad group and ad switched on), so PUT /v1/ads/campaigns/{campaignId}/status with &#x60;active&#x60; brings it live. On LinkedIn the whole campaign group, campaign, and creative hierarchy stays PAUSED (intendedStatus PAUSED on each).</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Meta only, same semantics as POST /v1/ads/create: campaign &#x3D; Advantage campaign budget (CBO), the budget and bid strategy sit on the campaign and the ad set inherits them. Default adset. Not allowed with adSetId.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="platformPostId">Platform post ID (alternative to postId). Meta: a Page post id (&#x60;&lt;pageId&gt;_&lt;postId&gt;&#x60; or the bare post id) or an Instagram media id. On a Meta Ads business-login connection (platform metaads) the id is resolved live: an Instagram media id is boosted as that media, running as the Instagram account that owns it..</param>
        ...
        /// <param name="budgetAmount">Budget in whole currency units, the same flat field as POST /v1/ads/create. Required unless adSetId is set. Minimum varies: TikTok&#x3D;$20, Pinterest&#x3D;$5, others&#x3D;$1.</param>
        /// <param name="budgetType">Goes together with budgetAmount. lifetime requires schedule.endDate..</param>
        ...
        /// <param name="startDate">Ad-set start time (ISO 8601, e.g. \&quot;2026-06-10T09:00:00Z\&quot;), mapped to the ad set&#39;s &#x60;start_time&#x60;. When omitted the ad starts delivering immediately. Same field as on POST /v1/ads/create..</param>
        /// <param name="endDate">Ad-set end time (ISO 8601), mapped to the ad set&#39;s &#x60;end_time&#x60;. Required for lifetime budgets. Same field as on POST /v1/ads/create..</param>
        /// <param name="schedule">schedule.</param>
        /// <param name="targeting">targeting.</param>
        /// <param name="locationTargetingType">Google only (400 elsewhere). Written on the campaign the boost creates..</param>
        ...
        /// <param name="status">Meta, TikTok, LinkedIn, and Google. Publish state of the created entities. Omitted or ACTIVE publishes live (default); PAUSED creates them paused so you can review before they spend. On Meta a new campaign stays paused until explicitly activated; an attached ad is itself paused. On Google the pause is held on the campaign the boost creates (ad group and ad switched on), so PUT /v1/ads/campaigns/{campaignId}/status with &#x60;active&#x60; brings it live. On LinkedIn the whole campaign group, campaign, and creative hierarchy stays PAUSED (intendedStatus PAUSED on each)..</param>
        /// <param name="budgetLevel">Meta only, same semantics as POST /v1/ads/create: campaign &#x3D; Advantage campaign budget (CBO), the budget and bid strategy sit on the campaign and the ad set inherits them. Default adset. Not allowed with adSetId..</param>
        /// <param name="attributionSpec">Meta only. Ad-set attribution windows, same shape as POST /v1/ads/create. Applied on OUTCOME_SALES, OUTCOME_LEADS and OUTCOME_APP_PROMOTION campaigns (conversions, lead_conversion, lead_generation, app_promotion); other objectives keep Meta&#39;s default. Not allowed with adSetId..</param>
        /// <param name="bodies">Meta only. Extra primary-text options Meta rotates on the boosted post (asset_feed_spec.bodies with DEGREES_OF_FREEDOM); the post keeps its own text as one of the options. Works for Facebook posts and Instagram media. Under a conversions or traffic goal Meta also wants a website URL on the options, taken from &#x60;linkUrl&#x60; (send it with a &#x60;callToAction&#x60;); engagement boosts need none..</param>
        ...
        */
        ...
        /// </summary>
        /// <value>Platform post ID (alternative to postId). Meta: a Page post id (&#x60;&lt;pageId&gt;_&lt;postId&gt;&#x60; or the bare post id) or an Instagram media id. On a Meta Ads business-login connection (platform metaads) the id is resolved live: an Instagram media id is boosted as that media, running as the Instagram account that owns it.</value>
        ...
        /// </summary>
        /// <value>Budget in whole currency units, the same flat field as POST /v1/ads/create. Required unless adSetId is set. Minimum varies: TikTok&#x3D;$20, Pinterest&#x3D;$5, others&#x3D;$1</value>
        ...
        */
        ...
        /// </summary>
        /// <value>Ad-set start time (ISO 8601, e.g. \&quot;2026-06-10T09:00:00Z\&quot;), mapped to the ad set&#39;s &#x60;start_time&#x60;. When omitted the ad starts delivering immediately. Same field as on POST /v1/ads/create.</value>
        ...
        /// </summary>
        /// <value>Ad-set end time (ISO 8601), mapped to the ad set&#39;s &#x60;end_time&#x60;. Required for lifetime budgets. Same field as on POST /v1/ads/create.</value>
        ...
        /// </summary>
        /// <value>Meta only. Ad-set attribution windows, same shape as POST /v1/ads/create. Applied on OUTCOME_SALES, OUTCOME_LEADS and OUTCOME_APP_PROMOTION campaigns (conversions, lead_conversion, lead_generation, app_promotion); other objectives keep Meta&#39;s default. Not allowed with adSetId.</value>
        ...
        /// </summary>
        /// <value>Meta only. Extra primary-text options Meta rotates on the boosted post (asset_feed_spec.bodies with DEGREES_OF_FREEDOM); the post keeps its own text as one of the options. Works for Facebook posts and Instagram media. Under a conversions or traffic goal Meta also wants a website URL on the options, taken from &#x60;linkUrl&#x60; (send it with a &#x60;callToAction&#x60;); engagement boosts need none.</value>
