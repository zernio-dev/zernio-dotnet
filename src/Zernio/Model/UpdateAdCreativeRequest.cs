...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateAdCreative_request")]
    public partial class UpdateAdCreativeRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAdCreativeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateAdCreativeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAdCreativeRequest" /> class.
        /// </summary>
        ...
        public UpdateAdCreativeRequest(string accountId = default, string name = default)
        {
            ...
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for UpdateAdCreativeRequest and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateAdCreativeRequest and cannot be null");
            }
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateAdCreativeRequest {\n");
