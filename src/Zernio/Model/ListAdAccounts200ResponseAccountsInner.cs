...
namespace Zernio.Model
{
    ...
    public partial class ListAdAccounts200ResponseAccountsInner : IValidatableObject
    {
        ...
        public ListAdAccounts200ResponseAccountsInner(string id = default, string name = default, string currency = default, string businessId = default, string businessName = default, string status = default, Object accountStatus = default, string approvalStatus = default, int disableReason = default, string timezoneName = default, decimal timezoneOffsetHoursUtc = default, decimal minimumDailyBudget = default, bool selectable = default, string unusableReason = default)
        {
            this.Id = id;
            this.Name = name;
