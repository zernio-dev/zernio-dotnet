...
namespace Zernio.Model
{
    ...
    public partial class ListAdAccounts200ResponseAccountsInner : IValidatableObject
    {
        ...
        /// <param name="fundingSource">Meta only. Meta&#39;s &#x60;funding_source&#x60; ID for the ad account, forwarded unchanged. ABSENT when this connection&#39;s token cannot see billing on the account, which is not the same as the account having no payment method: never read the missing key as &#x60;no payment method configured&#x60;..</param>
        ...
        public ListAdAccounts200ResponseAccountsInner(string id = default, string name = default, string currency = default, string businessId = default, string businessName = default, string status = default, Object accountStatus = default, string approvalStatus = default, int disableReason = default, string timezoneName = default, decimal timezoneOffsetHoursUtc = default, decimal minimumDailyBudget = default, string fundingSource = default, ListAdAccounts200ResponseAccountsInnerFundingSourceDetails fundingSourceDetails = default, bool selectable = default, string unusableReason = default)
        {
            this.Id = id;
            this.Name = name;
        ...
        /// </summary>
        /// <value>Meta only. Meta&#39;s &#x60;funding_source&#x60; ID for the ad account, forwarded unchanged. ABSENT when this connection&#39;s token cannot see billing on the account, which is not the same as the account having no payment method: never read the missing key as &#x60;no payment method configured&#x60;.</value>
