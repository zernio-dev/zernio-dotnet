...
namespace Zernio.Model
{
    ...
    public partial class CreateCtwaAdRequest : IValidatableObject
    {
        ...
        public List<CreateCtwaAdRequestCustomLocationsInner> CustomLocations { get; set; }
