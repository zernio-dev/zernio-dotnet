...
namespace Zernio.Model
{
    ...
    public partial class AccountsListResponse : IValidatableObject
    {
        ...
        protected AccountsListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountsListResponse" /> class.
        /// </summary>
        ...
        public AccountsListResponse(List<SocialAccount> accounts = default, bool hasAnalyticsAccess = default, Pagination pagination = default)
        {
            // to ensure "accounts" is required (not null)
            if (accounts == null)
            {
                throw new ArgumentNullException("accounts is a required property for AccountsListResponse and cannot be null");
            }
