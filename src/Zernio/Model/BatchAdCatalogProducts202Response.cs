...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "batchAdCatalogProducts_202_response")]
    public partial class BatchAdCatalogProducts202Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchAdCatalogProducts202Response" /> class.
        /// </summary>
        /// <param name="handles">handles.</param>
        /// <param name="statusUrl">statusUrl.</param>
        public BatchAdCatalogProducts202Response(List<string> handles = default, string statusUrl = default)
        {
