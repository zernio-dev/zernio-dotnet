...
namespace Zernio.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(SubmitWhatsAppNumberKycRequestDocumentsInnerJsonConverter))]
    [DataContract(Name = "submitWhatsAppNumberKyc_request_documents_inner")]
    public partial class SubmitWhatsAppNumberKycRequestDocumentsInner : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, SubmitWhatsAppNumberKycRequestDocumentsInner.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of SubmitWhatsAppNumberKycRequestDocumentsInner
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of SubmitWhatsAppNumberKycRequestDocumentsInner</returns>
        public static SubmitWhatsAppNumberKycRequestDocumentsInner FromJson(string jsonString)
        {
            SubmitWhatsAppNumberKycRequestDocumentsInner newSubmitWhatsAppNumberKycRequestDocumentsInner = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newSubmitWhatsAppNumberKycRequestDocumentsInner;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newSubmitWhatsAppNumberKycRequestDocumentsInner = new SubmitWhatsAppNumberKycRequestDocumentsInner(JsonConvert.DeserializeObject<SubmitWhatsAppNumberKycRequestDocumentsInnerOneOf>(jsonString, SubmitWhatsAppNumberKycRequestDocumentsInner.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// <summary>
    /// Custom JSON converter for SubmitWhatsAppNumberKycRequestDocumentsInner
    /// </summary>
    public class SubmitWhatsAppNumberKycRequestDocumentsInnerJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(SubmitWhatsAppNumberKycRequestDocumentsInner).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return SubmitWhatsAppNumberKycRequestDocumentsInner.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return SubmitWhatsAppNumberKycRequestDocumentsInner.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
