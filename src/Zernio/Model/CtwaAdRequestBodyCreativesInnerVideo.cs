...
namespace Zernio.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CtwaAdRequestBodyCreativesInnerVideo" /> class.
        /// </summary>
        ...
        /// <param name="thumbnailUrl">OPTIONAL: when omitted, the poster is auto-generated from Meta&#39;s own preferred video thumbnail. When Meta produces no candidate the request fails with a 502 platform_error (reason: video_thumbnail_unavailable). .</param>
        public CtwaAdRequestBodyCreativesInnerVideo(string url = default, string id = default, string thumbnailUrl = default)
        {
            this.Url = url;
            this.Id = id;
        ...
        /// </summary>
        /// <value>OPTIONAL: when omitted, the poster is auto-generated from Meta&#39;s own preferred video thumbnail. When Meta produces no candidate the request fails with a 502 platform_error (reason: video_thumbnail_unavailable). </value>
