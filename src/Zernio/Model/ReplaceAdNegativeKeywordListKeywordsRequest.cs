...
namespace Zernio.Model
{
    ...
    public partial class ReplaceAdNegativeKeywordListKeywordsRequest : IValidatableObject
    {
        ...
        public ReplaceAdNegativeKeywordListKeywordsRequest(string accountId = default, string customerId = default, PlatformEnum? platform = default, List<KeywordEntry> keywords = default)
        {
