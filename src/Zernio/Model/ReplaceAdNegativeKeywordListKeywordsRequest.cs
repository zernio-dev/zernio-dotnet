...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "replaceAdNegativeKeywordListKeywords_request")]
    public partial class ReplaceAdNegativeKeywordListKeywordsRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplaceAdNegativeKeywordListKeywordsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReplaceAdNegativeKeywordListKeywordsRequest()
        {
        ...
        /// <param name="keywords">Full desired keyword set. Bare strings use broad match. Send [] to clear the list. (required).</param>
        public ReplaceAdNegativeKeywordListKeywordsRequest(string accountId = default, string adAccountId = default, string customerId = default, PlatformEnum? platform = default, List<KeywordEntry> keywords = default)
        {
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for ReplaceAdNegativeKeywordListKeywordsRequest and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "keywords" is required (not null)
            if (keywords == null)
            {
                throw new ArgumentNullException("keywords is a required property for ReplaceAdNegativeKeywordListKeywordsRequest and cannot be null");
            }
