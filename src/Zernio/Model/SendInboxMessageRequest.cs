...
namespace Zernio.Model
{
    ...
    public partial class SendInboxMessageRequest : IValidatableObject
    {
        ...
        /// <param name="linkPreview">WhatsApp only. Set false to send the message without a link-preview thumbnail for the first URL in the text. Defaults to true, which is how every WhatsApp text has been sent to date. Ignored on other platforms. Accepted on the JSON body only, not on multipart requests. (default to true).</param>
        ...
        /// </summary>
        /// <value>WhatsApp only. Set false to send the message without a link-preview thumbnail for the first URL in the text. Defaults to true, which is how every WhatsApp text has been sent to date. Ignored on other platforms. Accepted on the JSON body only, not on multipart requests.</value>
