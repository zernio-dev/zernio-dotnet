...
namespace Zernio.Model
{
    ...
    public partial class CreateStandaloneAdRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Meta Lead Gen forms only (facebook/instagram). The leadgen_forms ID to attach to the ad&#39;s creative — create one via POST /v1/ads/lead-forms. REQUIRED when &#x60;goal&#x60; is &#x60;lead_generation&#x60;; ignored otherwise. The ad set&#39;s promoted_object.page_id + LEAD_GENERATION optimization are derived automatically from the goal. NOT compatible with &#x60;placementAssets&#x60; (per-placement creative) or &#x60;dynamicCreative&#x60; (multiple assets/text): Meta does not allow an asset_feed_spec creative on instant-form lead ads, so that combination is rejected with INVALID_FIELD_VALUE. Per-placement / multi-asset creative is supported on &#x60;traffic&#x60; and &#x60;conversions&#x60; goals.</value>
