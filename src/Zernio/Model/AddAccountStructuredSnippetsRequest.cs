...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addAccountStructuredSnippets_request")]
    public partial class AddAccountStructuredSnippetsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddAccountStructuredSnippetsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddAccountStructuredSnippetsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddAccountStructuredSnippetsRequest" /> class.
        /// </summary>
        ...
        /// <param name="structuredSnippets">structuredSnippets (required).</param>
        public AddAccountStructuredSnippetsRequest(string accountId = default, string adAccountId = default, string customerId = default, List<GoogleStructuredSnippet> structuredSnippets = default)
        {
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for AddAccountStructuredSnippetsRequest and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "structuredSnippets" is required (not null)
            if (structuredSnippets == null)
            {
                throw new ArgumentNullException("structuredSnippets is a required property for AddAccountStructuredSnippetsRequest and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "structuredSnippets", IsRequired = true, EmitDefaultValue = true)]
