...
namespace Zernio.Model
{
    ...
    public partial class WebhookPayloadMessageSentMessage : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>WhatsApp send origin. whatsapp_business_app when sent from the WhatsApp Business phone app on a Coexistence number; cloud_api when sent through Zernio (dashboard, API, or broadcasts); meta_business_agent when Meta Business Agent answered on the number. Absent on non-WhatsApp platforms. Says where WhatsApp saw the send come from, not which Zernio surface produced it: read sentVia for that.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum SourceEnum
        {
            ...
            /// <summary>
            /// Enum MetaBusinessAgent for value: meta_business_agent
            /// </summary>
            [EnumMember(Value = "meta_business_agent")]
            MetaBusinessAgent = 3
        }
        ...
        /// <param name="source">WhatsApp send origin. whatsapp_business_app when sent from the WhatsApp Business phone app on a Coexistence number; cloud_api when sent through Zernio (dashboard, API, or broadcasts); meta_business_agent when Meta Business Agent answered on the number. Absent on non-WhatsApp platforms. Says where WhatsApp saw the send come from, not which Zernio surface produced it: read sentVia for that..</param>
        ...
        public List<WebhookPayloadMessageSentMessageAttachmentsInner> Attachments { get; set; }
