...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getDailyMetrics_200_response_dailyData_inner_metrics")]
    public partial class GetDailyMetrics200ResponseDailyDataInnerMetrics : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDailyMetrics200ResponseDailyDataInnerMetrics" /> class.
        /// </summary>
        ...
        public GetDailyMetrics200ResponseDailyDataInnerMetrics(int impressions = default, int reach = default, int likes = default, int comments = default, int shares = default, int saves = default, int clicks = default, int views = default)
        {
