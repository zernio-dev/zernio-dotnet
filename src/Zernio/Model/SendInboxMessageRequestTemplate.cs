...
namespace Zernio.Model
{
    ...
    public partial class SendInboxMessageRequestTemplate : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Facebook only. Aspect ratio Messenger renders element images at: horizontal (1.91:1, default) or square (1:1). A 400 on Instagram.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="imageAspectRatio">Facebook only. Aspect ratio Messenger renders element images at: horizontal (1.91:1, default) or square (1:1). A 400 on Instagram..</param>
        /// <param name="elements">elements.</param>
        public SendInboxMessageRequestTemplate(TypeEnum? type = default, ImageAspectRatioEnum? imageAspectRatio = default, List<SendInboxMessageRequestTemplateElementsInner> elements = default)
        {
            this.Type = type;
