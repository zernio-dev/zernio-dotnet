...
namespace Zernio.Model
{
    ...
    public partial class AdCreative : IValidatableObject
    {
        ...
        public AdCreative(GooglePmaxAssetGroupInput assetGroup = default, string assetGroupResourceName = default, List<GoogleRsaHeadline> headlines = default, List<GoogleRsaDescription> descriptions = default, List<string> finalUrls = default, string thumbnailUrl = default, string imageUrl = default, string videoId = default, string videoUrl = default, string creativeId = default, string objectType = default, string objectStoryId = default, string effectiveObjectStoryId = default, string pageId = default, string effectiveInstagramMediaId = default, string instagramUserId = default, string instagramPermalinkUrl = default, List<string> mediaUrls = default, bool? isServing = default, string adFormat = default, List<string> servingHoldReasons = default, string body = default, string googleHeadline = default, string googleDescription = default, string linkUrl = default, string whatsappPhoneNumber = default, string pinterestImageUrl = default, string pinterestTitle = default, string pinterestDescription = default)
        {
        ...
        */
        ...
        /// </summary>
        /// <value>LinkedIn only. The LinkedIn ad format, in LinkedIn&#39;s own vocabulary: STANDARD_UPDATE, SINGLE_VIDEO, CAROUSEL, NATIVE_DOCUMENT, EVENT, TEXT_AD, SPOTLIGHT, FOLLOW_COMPANY, JOBS, SPONSORED_INMAILS and others. On an ad Zernio created this is the format it was created as; on an ad synced from Campaign Manager it is the parent campaign&#39;s raw &#x60;format&#x60;, which is what LinkedIn actually enforces on its creatives. The list is open, so treat an unrecognized value as valid. Absent on LinkedIn ads not yet re-synced, and on every other platform.</value>
        [DataMember(Name = "adFormat", EmitDefaultValue = true)]
