...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateValueRuleSet_request")]
    public partial class UpdateValueRuleSetRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateValueRuleSetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateValueRuleSetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateValueRuleSetRequest" /> class.
        /// </summary>
        ...
        public UpdateValueRuleSetRequest(string accountId = default, string name = default, List<ValueRule> rules = default)
        {
            ...
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for UpdateValueRuleSetRequest and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateValueRuleSetRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "rules" is required (not null)
            if (rules == null)
            {
                throw new ArgumentNullException("rules is a required property for UpdateValueRuleSetRequest and cannot be null");
            }
            this.Rules = rules;
        }
        ...
        /// </summary>
        /// <value>Required: the update replaces the whole set.</value>
        ...
        /// </summary>
        /// <value>The COMPLETE rule list. Omitting a rule deletes it on Meta.</value>
