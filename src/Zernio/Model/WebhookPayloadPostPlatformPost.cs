...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookPayloadPostPlatform_post")]
    public partial class WebhookPayloadPostPlatformPost : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPayloadPostPlatformPost" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookPayloadPostPlatformPost() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPayloadPostPlatformPost" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="content">content (required).</param>
        /// <param name="status">Post-level status AT FIRE TIME. May still be &#x60;publishing&#x60; if other platforms haven&#39;t terminated; check this field rather than assuming.  (required).</param>
        ...
        public WebhookPayloadPostPlatformPost(string id = default, string content = default, string status = default, DateTime scheduledFor = default, DateTime publishedAt = default, List<WebhookPayloadPostPlatformPostPlatformsInner> platforms = default, Dictionary<string, Object> metadata = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for WebhookPayloadPostPlatformPost and cannot be null");
            }
            this.Id = id;
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new ArgumentNullException("content is a required property for WebhookPayloadPostPlatformPost and cannot be null");
            }
            this.Content = content;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for WebhookPayloadPostPlatformPost and cannot be null");
            }
            this.Status = status;
            ...
            if (platforms == null)
            {
                throw new ArgumentNullException("platforms is a required property for WebhookPayloadPostPlatformPost and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Post-level status AT FIRE TIME. May still be &#x60;publishing&#x60; if other platforms haven&#39;t terminated; check this field rather than assuming. </value>
