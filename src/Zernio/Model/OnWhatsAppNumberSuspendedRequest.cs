...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "onWhatsAppNumberSuspended_request")]
    public partial class OnWhatsAppNumberSuspendedRequest : IValidatableObject
    {
        /// <summary>
        /// Defines Event
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OnWhatsAppNumberSuspendedRequest" /> class.
        /// </summary>
        ...
        public OnWhatsAppNumberSuspendedRequest(string id = default, EventEnum? varEvent = default, DateTime timestamp = default, OnWhatsAppNumberDeclinedRequestNumber number = default, string reason = default)
        {
            this.Id = id;
            this.Event = varEvent;
