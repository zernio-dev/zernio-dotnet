...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApiKey_createdBy")]
    public partial class ApiKeyCreatedBy : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiKeyCreatedBy" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="email">email.</param>
        public ApiKeyCreatedBy(string id = default, string email = default)
        {
            this.Id = id;
            this.Email = email;
        }
