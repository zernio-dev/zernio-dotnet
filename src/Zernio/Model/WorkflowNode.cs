...
namespace Zernio.Model
{
    ...
    public partial class WorkflowNode : IValidatableObject
    {
        ...
        /// <param name="label">Optional display name shown on the builder canvas and inspector, falling back to the node type when absent. The nodes array is replaced wholesale on update, so it must be resent to be kept..</param>
        public WorkflowNode(string id = default, TypeEnum type = default, Dictionary<string, Object> config = default, WorkflowNodePosition position = default, string label = default)
        {
        ...
        /// </summary>
        /// <value>Optional display name shown on the builder canvas and inspector, falling back to the node type when absent. The nodes array is replaced wholesale on update, so it must be resent to be kept.</value>
