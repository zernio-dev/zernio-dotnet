...
namespace Zernio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "sendInboxMessage_request_interactive_action_oneOf_3_parameters")]
    public partial class SendInboxMessageRequestInteractiveActionOneOf3Parameters : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SendInboxMessageRequestInteractiveActionOneOf3Parameters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SendInboxMessageRequestInteractiveActionOneOf3Parameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SendInboxMessageRequestInteractiveActionOneOf3Parameters" /> class.
        /// </summary>
        ...
        public SendInboxMessageRequestInteractiveActionOneOf3Parameters(FlowMessageVersionEnum? flowMessageVersion = default, string flowToken = default, string flowId = default, string flowCta = default, FlowActionEnum flowAction = default, SendInboxMessageRequestInteractiveActionOneOf3ParametersFlowActionPayload flowActionPayload = default, ModeEnum? mode = default)
        {
            // to ensure "flowToken" is required (not null)
            if (flowToken == null)
            {
                throw new ArgumentNullException("flowToken is a required property for SendInboxMessageRequestInteractiveActionOneOf3Parameters and cannot be null");
            }
            this.FlowToken = flowToken;
            // to ensure "flowId" is required (not null)
            if (flowId == null)
            {
                throw new ArgumentNullException("flowId is a required property for SendInboxMessageRequestInteractiveActionOneOf3Parameters and cannot be null");
            }
            this.FlowId = flowId;
            // to ensure "flowCta" is required (not null)
            if (flowCta == null)
            {
                throw new ArgumentNullException("flowCta is a required property for SendInboxMessageRequestInteractiveActionOneOf3Parameters and cannot be null");
            }
        ...
        public SendInboxMessageRequestInteractiveActionOneOf3ParametersFlowActionPayload FlowActionPayload { get; set; }
