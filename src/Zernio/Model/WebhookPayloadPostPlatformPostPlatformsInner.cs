...
namespace Zernio.Model
{
    ...
    public partial class WebhookPayloadPostPlatformPostPlatformsInner : IValidatableObject
    {
        ...
        public WebhookPayloadPostPlatformPostPlatformsInner(string platform = default, string status = default, string accountId = default, string platformPostId = default, string publishedUrl = default, string error = default, PostPlatformError platformError = default)
        {
