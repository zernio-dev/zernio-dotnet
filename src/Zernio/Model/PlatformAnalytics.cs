...
namespace Zernio.Model
{
    ...
    public partial class PlatformAnalytics : IValidatableObject
    {
        ...
        /// <param name="errorMessage">Error details when status is failed, or why analytics are unavailable for a published entry (e.g. Google Business Profile, a TikTok upload that never received a video id).</param>
        ...
        /// </summary>
        /// <value>Error details when status is failed, or why analytics are unavailable for a published entry (e.g. Google Business Profile, a TikTok upload that never received a video id)</value>
