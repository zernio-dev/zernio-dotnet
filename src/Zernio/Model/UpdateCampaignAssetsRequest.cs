...
{
    /// <summary>
    /// UpdateCampaignAssetsRequest
    /// </summary>
    [DataContract(Name = "updateCampaignAssets_request")]
    public partial class UpdateCampaignAssetsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCampaignAssetsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateCampaignAssetsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCampaignAssetsRequest" /> class.
        /// </summary>
        ...
        public UpdateCampaignAssetsRequest(string accountId = default, string adAccountId = default, string customerId = default, List<GoogleAssetUpdate> updates = default)
        {
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for UpdateCampaignAssetsRequest and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "updates" is required (not null)
            if (updates == null)
            {
                throw new ArgumentNullException("updates is a required property for UpdateCampaignAssetsRequest and cannot be null");
            }
        ...
        public List<GoogleAssetUpdate> Updates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateCampaignAssetsRequest {\n");
