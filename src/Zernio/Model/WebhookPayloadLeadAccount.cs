...
namespace Zernio.Model
{
    ...
    public partial class WebhookPayloadLeadAccount : IValidatableObject
    {
        ...
        /// <param name="profileId">Profile ID of the account that received the lead. Null when the lead has no profile on record. (required).</param>
        public WebhookPayloadLeadAccount(string id = default, string accountId = default, PlatformEnum platform = default, string profileId = default)
        {
            ...
            if (profileId == null)
            {
                throw new ArgumentNullException("profileId is a required property for WebhookPayloadLeadAccount and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Profile ID of the account that received the lead. Null when the lead has no profile on record.</value>
