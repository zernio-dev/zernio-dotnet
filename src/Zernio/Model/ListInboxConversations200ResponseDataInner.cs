...
namespace Zernio.Model
{
    ...
    public partial class ListInboxConversations200ResponseDataInner : IValidatableObject
    {
        ...
        /// <param name="isGroup">iMessage only, true for a group thread. Manage it through the /v1/imessage/groups/{conversationId} endpoints..</param>
        ...
        /// </summary>
        /// <value>iMessage only, true for a group thread. Manage it through the /v1/imessage/groups/{conversationId} endpoints.</value>
