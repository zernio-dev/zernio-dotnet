...
namespace Zernio.Model
{
    ...
    /// MetaProductCatalog
    /// </summary>
    [DataContract(Name = "MetaProductCatalog")]
    public partial class MetaProductCatalog : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetaProductCatalog" /> class.
        /// </summary>
        ...
        public MetaProductCatalog(string id = default, string name = default, string vertical = default, int productCount = default, string businessId = default)
        {
            this.Id = id;
            this.Name = name;
