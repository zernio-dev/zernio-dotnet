...
namespace Zernio.Model
{
    ...
    public partial class UpdateAdRequestBudget : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>OpenAI Ads accepts both and sets the campaign&#39;s single spend cap, replacing the previous daily or lifetime cap. A daily cap cannot go back to lifetime (422).</value>
        ...
        /// <param name="type">OpenAI Ads accepts both and sets the campaign&#39;s single spend cap, replacing the previous daily or lifetime cap. A daily cap cannot go back to lifetime (422)..</param>
