...
namespace Late.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listBroadcasts_200_response_broadcasts_inner")]
    public partial class ListBroadcasts200ResponseBroadcastsInner : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListBroadcasts200ResponseBroadcastsInner" /> class.
        /// </summary>
        ...
        public ListBroadcasts200ResponseBroadcastsInner(string id = default, string name = default, string description = default, string platform = default, string accountId = default, string accountName = default, StatusEnum? status = default, string messagePreview = default, DateTime scheduledAt = default, DateTime startedAt = default, DateTime completedAt = default, int recipientCount = default, int sentCount = default, int deliveredCount = default, int readCount = default, int failedCount = default, DateTime createdAt = default)
        {
            this.Id = id;
            this.Name = name;
