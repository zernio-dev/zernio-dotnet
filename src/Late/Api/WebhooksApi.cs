...
namespace Late.Api
{
    ...
    public partial class WebhooksApi : IDisposable, IWebhooksApi
    {
        ...
        public Late.Client.ApiResponse<GetWebhookLogs200Response> GetWebhookLogsWithHttpInfo(int? limit = default, string? status = default, string? varEvent = default, string? webhookId = default)
        {
            ...
            if (varEvent != null)
            {
                localVarRequestOptions.QueryParameters.Add(Late.Client.ClientUtils.ParameterToMultiMap("", "event", varEvent));
            }
            if (webhookId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Late.Client.ClientUtils.ParameterToMultiMap("", "webhookId", webhookId));
            }
