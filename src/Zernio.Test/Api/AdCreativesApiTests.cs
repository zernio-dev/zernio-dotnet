...
namespace Zernio.Test.Api
{
    ...
    public class AdCreativesApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ListAdsTikTokIdentities
        /// </summary>
        [Fact]
        public void ListAdsTikTokIdentitiesTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string accountId = null;
            //string adAccountId = null;
            //var response = instance.ListAdsTikTokIdentities(accountId, adAccountId);
            //Assert.IsType<ListAdsTikTokIdentities200Response>(response);
        }
