...
namespace Zernio.Test.Api
{
    ...
    public class ConnectApiTests : IDisposable
    {
        ...
        public void ConnectAdsTest()
        {
            ...
            //var response = instance.ConnectAds(platform, profileId, loginMode, permissionLevel, pageId, accountId, redirectUrl, headless, force, adAccountId, adAccountIds);
        ...
        /// </summary>
        [Fact]
        public void ConnectWordPressWithApplicationPasswordTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //ConnectWordPressWithApplicationPasswordRequest connectWordPressWithApplicationPasswordRequest = null;
            //var response = instance.ConnectWordPressWithApplicationPassword(connectWordPressWithApplicationPasswordRequest);
            //Assert.IsType<ConnectWordPressWithApplicationPassword200Response>(response);
        }
        ...
        /// <summary>
        /// Test GetWordPressAuthUrl
        /// </summary>
        [Fact]
        public void GetWordPressAuthUrlTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string profileId = null;
            //string? redirectUrl = null;
            //var response = instance.GetWordPressAuthUrl(profileId, redirectUrl);
            //Assert.IsType<GetWordPressAuthUrl200Response>(response);
        }
