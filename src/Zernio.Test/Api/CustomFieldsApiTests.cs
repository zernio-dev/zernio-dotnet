...
namespace Zernio.Test.Api
{
    ...
    public class CustomFieldsApiTests : IDisposable
    {
        ...
        public void CreateCustomFieldTest()
        {
            ...
            //var response = instance.CreateCustomField(createCustomFieldRequest);
            //Assert.IsType<CreateCustomField200Response>(response);
        }
        ...
        public void ListCustomFieldsTest()
        {
            ...
            //var response = instance.ListCustomFields(profileId);
            //Assert.IsType<ListCustomFields200Response>(response);
        }
