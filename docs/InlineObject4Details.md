# Zernio.Model.InlineObject4Details
...
**VerificationAmountCents** | **int** | One-time card verification charge in USD cents, credited to usage. Only set when reason&#x3D;card_verification_required. | [optional] 
