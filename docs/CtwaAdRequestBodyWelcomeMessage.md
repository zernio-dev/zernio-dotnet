# Zernio.Model.CtwaAdRequestBodyWelcomeMessage
...
**PrefillText** | **string** | Message put into the user&#39;s text input, ready to send. Replaces Meta&#39;s default (\&quot;Hi! I want more info.\&quot;). Lets one ad steer the opening message toward what it promotes (e.g. a specific product). | 
