# Zernio.Model.WebhookPayloadMessageMessageSender
...
**ContactId** | **string** | Zernio CRM Contact id for this sender, when one exists (omitted for outgoing/business sender). | [optional] 
