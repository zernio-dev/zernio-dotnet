# Zernio.Model.CommentAutomationTemplate
...
------------ | ------------- | ------------- | -------------
**Type** | **string** |  | 
**ImageAspectRatio** | **string** | Facebook only. How Messenger renders each element imageUrl: horizontal (1.91:1, the default) or square (1:1). Instagram has no such setting, so an Instagram automation carrying it is a 400. | [optional] 
