...
**StartedWatching** | **int** | Viewers who started watching in this segment. 0 when YouTube has no segment-level data for the video. | [optional] 
**StoppedWatching** | **int** | Viewers who stopped watching in this segment. 0 when YouTube has no segment-level data for the video. | [optional] 
