...
------------ | ------------- | ------------- | -------------
**WebhookId** | **string** | Webhook ID to update. Required unless the deprecated &#x60;_id&#x60; is sent instead. | [optional] 
