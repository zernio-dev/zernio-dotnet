...
Official .NET SDK for the [Zernio API](https://zernio.com). Schedule and manage social media posts programmatically.

> **Note:** This package uses the `Late` namespace for backwards compatibility (e.g. `using Late.Api;`). This will be migrated to `Zernio` in a future major version.
